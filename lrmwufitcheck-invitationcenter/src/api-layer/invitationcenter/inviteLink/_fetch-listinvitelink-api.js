...
const { dbScript_fetchListinvitelink } = require("dbLayer");
...
class _fetchListInviteLinkManager extends InviteLinkManager {
  ...
  async executeMainOperation() {
    return await dbScript_fetchListinvitelink(this);
...
module.exports = _fetchListInviteLinkManager;
