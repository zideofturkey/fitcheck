...
/**
 * Updates all InviteAudit records matching an MScript Query.
 ...
 */
const updateInviteAuditByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingInviteAuditByMQuery",
      err,
    );
  }
};

module.exports = updateInviteAuditByMQuery;
