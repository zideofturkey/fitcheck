...
/**
 * @deprecated Use updateInviteAuditByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateInviteAuditByQuery = async (dataClause, query, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingInviteAuditByQuery",
      err,
    );
  }
};

module.exports = updateInviteAuditByQuery;
