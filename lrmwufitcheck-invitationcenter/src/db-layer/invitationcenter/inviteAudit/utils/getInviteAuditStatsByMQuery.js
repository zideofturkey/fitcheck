...
/**
 * Calculates statistics on InviteAudit records matching an MScript Query.
 ...
 */
const getInviteAuditStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingInviteAuditStatsByMQuery",
      err,
    );
  }
};

module.exports = getInviteAuditStatsByMQuery;
