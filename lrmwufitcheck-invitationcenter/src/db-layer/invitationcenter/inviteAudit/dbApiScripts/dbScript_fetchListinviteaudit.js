...
// This script is called from the _fetchListInviteAuditManager
...
const dbScript_fetchListinviteaudit = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScript_fetchListinviteaudit",
      {
...
module.exports = dbScript_fetchListinviteaudit;
