...
/**
 * @deprecated Use updateInviteLinkByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateInviteLinkByQuery = async (dataClause, query, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingInviteLinkByQuery",
      err,
    );
  }
};

module.exports = updateInviteLinkByQuery;
