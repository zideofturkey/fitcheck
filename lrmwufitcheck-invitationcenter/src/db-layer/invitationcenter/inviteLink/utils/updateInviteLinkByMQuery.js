...
/**
 * Updates all InviteLink records matching an MScript Query.
 ...
 */
const updateInviteLinkByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingInviteLinkByMQuery",
      err,
    );
  }
};

module.exports = updateInviteLinkByMQuery;
