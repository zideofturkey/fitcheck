...
// This script is called from the GetInviteLinkByCodeManager
...
const dbScriptGetInvitelinkbycode = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await InviteLink.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetInvitelinkbycode",
      {
...
module.exports = dbScriptGetInvitelinkbycode;
