...
// This script is called from the GetInviteLinkManager
...
const dbScriptGetInvitelink = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetInvitelink",
      {
...
module.exports = dbScriptGetInvitelink;
