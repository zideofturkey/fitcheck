...
// This script is called from the ListInviteLinksManager
...
const dbScriptListInvitelinks = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListInvitelinks",
      {
...
module.exports = dbScriptListInvitelinks;
