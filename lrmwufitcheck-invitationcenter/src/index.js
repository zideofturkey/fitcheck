...
console.log("Starting fitcheck-invitationcenter-service service...");
...
const start = async () => {
  process.title = "node-lrmwufitcheck-invitationcenter-service";
  ...
  try {
    ...
    await setRedisData(
      "lrmwufitcheck-invitationcenter-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key lrmwufitcheck-invitationcenter-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "fitcheck-invitationcenter-service is listening HTTP/REST port " +
...
/* starting the server fitcheck-invitationcenter-service .... */
start();
