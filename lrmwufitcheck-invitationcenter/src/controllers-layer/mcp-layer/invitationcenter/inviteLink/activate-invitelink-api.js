...
class ActivateInviteLinkMcpController extends InvitationCenterServiceMcpController {
  constructor(params) {
    super("activateInviteLink", "activateinvitelink", params);
    this.dataName = "inviteLink";
    this.crudType = "update";
  }

  createApiManager() {
    return new ActivateInviteLinkManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    description:
      ...
      requiredRolesMarker,
    requiredRoles,
    parameters: ActivateInviteLinkMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new ActivateInviteLinkMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return ActivateInviteLinkMcpController.getOutputSchema().parse(result);
