...
const m2mUpdateInviteAuditByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateInviteAuditByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateInviteAuditById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateInviteAuditByIdHandler;
