...
const m2mDeleteInviteAuditByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteInviteAuditByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteInviteAuditByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteInviteAuditByQueryHandler;
