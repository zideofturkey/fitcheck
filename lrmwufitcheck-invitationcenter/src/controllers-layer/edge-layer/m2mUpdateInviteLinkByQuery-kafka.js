...
const m2mUpdateInviteLinkByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateInviteLinkByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateInviteLinkByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateInviteLinkByQueryHandler;
