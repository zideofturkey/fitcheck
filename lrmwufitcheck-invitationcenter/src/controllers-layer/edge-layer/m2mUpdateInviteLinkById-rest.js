...
const m2mUpdateInviteLinkByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateInviteLinkByIdInvalidM2MToken",
    ...
    const result = await m2mUpdateInviteLinkById(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateInviteLinkById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateInviteLinkByIdRestController;
