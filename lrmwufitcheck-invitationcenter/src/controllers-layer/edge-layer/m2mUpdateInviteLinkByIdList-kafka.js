...
const m2mUpdateInviteLinkByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateInviteLinkByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateInviteLinkByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateInviteLinkByIdListHandler;
