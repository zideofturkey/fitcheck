...
const m2mBulkCreateInviteLinkRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreateInviteLinkInvalidM2MToken",
    ...
    const result = await m2mBulkCreateInviteLink(req);
    ...
    console.error(
      "Error running routeService for m2mBulkCreateInviteLink: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mBulkCreateInviteLinkRestController;
