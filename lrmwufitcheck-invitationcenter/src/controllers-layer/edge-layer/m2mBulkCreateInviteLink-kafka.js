...
const m2mBulkCreateInviteLinkHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateInviteLinkRequiresM2MToken",
    ...
    const result = await m2mBulkCreateInviteLink(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateInviteLinkHandler;
