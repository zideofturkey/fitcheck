...
const m2mDeleteInviteAuditByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteInviteAuditByIdInvalidM2MToken",
    ...
    const result = await m2mDeleteInviteAuditById(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteInviteAuditById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteInviteAuditByIdRestController;
