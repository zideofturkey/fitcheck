...
const m2mUpdateInviteLinkByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateInviteLinkByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateInviteLinkById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateInviteLinkByIdHandler;
