...
const m2mDeleteInviteLinkByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteInviteLinkByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteInviteLinkById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteInviteLinkByIdHandler;
