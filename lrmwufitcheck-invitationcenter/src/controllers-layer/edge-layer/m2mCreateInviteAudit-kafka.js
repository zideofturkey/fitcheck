...
const m2mCreateInviteAuditHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateInviteAuditRequiresM2MToken",
    ...
    const result = await m2mCreateInviteAudit(message);
    // log result
  } catch (err) {
...
module.exports = m2mCreateInviteAuditHandler;
