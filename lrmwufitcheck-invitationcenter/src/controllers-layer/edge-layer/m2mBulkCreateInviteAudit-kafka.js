...
const m2mBulkCreateInviteAuditHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateInviteAuditRequiresM2MToken",
    ...
    const result = await m2mBulkCreateInviteAudit(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateInviteAuditHandler;
