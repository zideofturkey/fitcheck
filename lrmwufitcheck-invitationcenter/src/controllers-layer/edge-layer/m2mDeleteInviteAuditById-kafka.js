...
const m2mDeleteInviteAuditByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteInviteAuditByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteInviteAuditById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteInviteAuditByIdHandler;
