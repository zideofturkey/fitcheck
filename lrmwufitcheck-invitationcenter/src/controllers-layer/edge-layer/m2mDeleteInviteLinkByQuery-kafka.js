...
const m2mDeleteInviteLinkByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteInviteLinkByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteInviteLinkByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteInviteLinkByQueryHandler;
