...
const m2mUpdateInviteAuditByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateInviteAuditByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateInviteAuditByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateInviteAuditByQueryHandler;
