...
const m2mBulkCreateInviteAuditRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreateInviteAuditInvalidM2MToken",
    ...
    const result = await m2mBulkCreateInviteAudit(req);
    ...
    console.error(
      "Error running routeService for m2mBulkCreateInviteAudit: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mBulkCreateInviteAuditRestController;
