...
const m2mUpdateInviteAuditByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateInviteAuditByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateInviteAuditByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateInviteAuditByIdListHandler;
