...
const m2mDeleteInviteLinkByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteInviteLinkByIdInvalidM2MToken",
    ...
    const result = await m2mDeleteInviteLinkById(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteInviteLinkById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteInviteLinkByIdRestController;
