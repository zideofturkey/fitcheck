...
const MODEL_REGISTRY = {
  inviteLink: {
    ...
    schemaPath: "../../models/schemas/inviteLink.schema",
    getModel: () => require("../../models").InviteLink,
    getTableName: () => {
      try {
        const Model = require("../../models").InviteLink;
        return Model?.getTableName?.() || "inviteLink";
      } catch {
        return "inviteLink";
      }
    },
  ...
  inviteAudit: {
    ...
    schemaPath: "../../models/schemas/inviteAudit.schema",
    getModel: () => require("../../models").InviteAudit,
    getTableName: () => {
      try {
        const Model = require("../../models").InviteAudit;
        return Model?.getTableName?.() || "inviteAudit";
      } catch {
        return "inviteAudit";
      }
    },
