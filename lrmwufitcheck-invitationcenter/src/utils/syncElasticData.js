...
const dataObjectRegistry = {
  inviteLink: {
    ...
    getById: getInviteLinkById,
    getIdList: getIdListOfInviteLinkByField,
    count: countInviteLink,
  },
  inviteAudit: {
    name: "inviteAudit",
    modelName: "InviteAudit",
    pluralName: "inviteAudits",
    getById: getInviteAuditById,
    getIdList: getIdListOfInviteAuditByField,
    count: countInviteAudit,
  },
};
