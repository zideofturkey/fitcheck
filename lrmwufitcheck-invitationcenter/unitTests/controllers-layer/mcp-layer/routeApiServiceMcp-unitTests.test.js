...
describe("CreateInviteLinkMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/inviteLink/create-invitelink-api.js",
      {
        apiLayer: { CreateInviteLinkManager: ManagerStub },
        "../../InvitationCenterServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createInviteLink");
