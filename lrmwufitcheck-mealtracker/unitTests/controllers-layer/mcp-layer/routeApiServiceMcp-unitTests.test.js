...
describe("CreateMealLogMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/mealLog/create-meallog-api.js",
      {
        apiLayer: { CreateMealLogManager: ManagerStub },
        "../../MealTrackerServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createMealLog");
