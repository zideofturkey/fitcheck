...
const mealTrackerPackage = grpcObject.mealTracker;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is fitcheck-mealtracker-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(mealTrackerPackage.mealTrackerService.service, {
  helloMessage,
  ...sessionRouter,
});
