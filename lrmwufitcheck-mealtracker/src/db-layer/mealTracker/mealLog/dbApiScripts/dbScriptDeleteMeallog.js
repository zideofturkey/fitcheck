...
// This script is called from the DeleteMealLogManager
...
const dbScriptDeleteMeallog = async (apiManager) => {
  ...
  try {
    const res = await MealLog.destroy({ where: instanceWhereClause });
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteMeallog",
      {
...
module.exports = dbScriptDeleteMeallog;
