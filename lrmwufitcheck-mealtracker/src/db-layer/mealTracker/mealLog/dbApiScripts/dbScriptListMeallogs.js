...
// This script is called from the ListMealLogsManager
...
const dbScriptListMeallogs = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListMeallogs",
      {
...
module.exports = dbScriptListMeallogs;
