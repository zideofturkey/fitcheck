...
// This script is called from the GetMealLogManager
...
const dbScriptGetMeallog = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await MealLog.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetMeallog",
      {
...
module.exports = dbScriptGetMeallog;
