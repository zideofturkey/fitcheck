...
/**
 * Calculates statistics on MealLog records matching an MScript Query.
 ...
 */
const getMealLogStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingMealLogStatsByMQuery",
      err,
    );
  }
};

module.exports = getMealLogStatsByMQuery;
