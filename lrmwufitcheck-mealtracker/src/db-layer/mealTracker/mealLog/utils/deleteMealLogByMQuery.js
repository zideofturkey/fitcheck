...
/**
 * Deletes all MealLog records matching an MScript Query.
 ...
 */
const deleteMealLogByMQuery = async (mQuery, context = null) => {
  try {
    ...
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenDeletingMealLogByMQuery", err);
  }
};

module.exports = deleteMealLogByMQuery;
