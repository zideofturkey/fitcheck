...
/**
 * Updates all MealLog records matching an MScript Query.
 ...
 */
const updateMealLogByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenUpdatingMealLogByMQuery", err);
  }
};

module.exports = updateMealLogByMQuery;
