...
// This script is called from the GetWeeklyAnalyticsManager
...
const dbScriptGetWeeklyanalytics = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetWeeklyanalytics",
      {
...
module.exports = dbScriptGetWeeklyanalytics;
