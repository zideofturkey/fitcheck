...
// This script is called from the GetMonthlyAnalyticsManager
...
const dbScriptGetMonthlyanalytics = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetMonthlyanalytics",
      {
...
module.exports = dbScriptGetMonthlyanalytics;
