...
// This script is called from the GetNutritionDayManager
...
const dbScriptGetNutritionday = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetNutritionday",
      {
...
module.exports = dbScriptGetNutritionday;
