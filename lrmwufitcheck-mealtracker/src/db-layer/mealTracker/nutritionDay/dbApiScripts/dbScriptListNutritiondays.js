...
// This script is called from the ListNutritionDaysManager
...
const dbScriptListNutritiondays = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListNutritiondays",
      {
...
module.exports = dbScriptListNutritiondays;
