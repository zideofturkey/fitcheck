...
// This script is called from the GetDailyProgressManager
...
const dbScriptGetDailyprogress = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await NutritionDay.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetDailyprogress",
      {
...
module.exports = dbScriptGetDailyprogress;
