...
/**
 * @deprecated Use updateNutritionDayByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateNutritionDayByQuery = async (dataClause, query, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingNutritionDayByQuery",
      err,
    );
  }
};

module.exports = updateNutritionDayByQuery;
