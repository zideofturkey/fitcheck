...
/**
 * Updates all NutritionDay records matching an MScript Query.
 ...
 */
const updateNutritionDayByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingNutritionDayByMQuery",
      err,
    );
  }
};

module.exports = updateNutritionDayByMQuery;
