...
/**
 * Calculates statistics on NutritionDay records matching an MScript Query.
 ...
 */
const getNutritionDayStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingNutritionDayStatsByMQuery",
      err,
    );
  }
};

module.exports = getNutritionDayStatsByMQuery;
