...
/**
 * Calculates statistics on MealLine records matching an MScript Query.
 ...
 */
const getMealLineStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingMealLineStatsByMQuery",
      err,
    );
  }
};

module.exports = getMealLineStatsByMQuery;
