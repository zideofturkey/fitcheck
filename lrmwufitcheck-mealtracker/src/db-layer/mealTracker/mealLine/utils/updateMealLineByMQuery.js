...
/**
 * Updates all MealLine records matching an MScript Query.
 ...
 */
const updateMealLineByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingMealLineByMQuery",
      err,
    );
  }
};

module.exports = updateMealLineByMQuery;
