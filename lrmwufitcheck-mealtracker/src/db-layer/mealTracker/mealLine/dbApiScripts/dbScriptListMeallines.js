...
// This script is called from the ListMealLinesManager
...
const dbScriptListMeallines = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListMeallines",
      {
...
module.exports = dbScriptListMeallines;
