...
app.use("", mealLogRouter);
app.use("", mealLineRouter);
app.use("", nutritionDayRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "fitcheck-mealTracker-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="fitcheck-mealTracker-postman-collection.json"',
  );
