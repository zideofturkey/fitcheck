...
const { dbScript_fetchListmeallog } = require("dbLayer");
...
class _fetchListMealLogManager extends MealLogManager {
  ...
  async executeMainOperation() {
    return await dbScript_fetchListmeallog(this);
...
module.exports = _fetchListMealLogManager;
