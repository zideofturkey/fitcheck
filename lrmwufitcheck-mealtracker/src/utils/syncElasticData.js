...
const {
  getMealLogById,
  getIdListOfMealLogByField,
  countMealLog,
  getMealLineById,
  getIdListOfMealLineByField,
  countMealLine,
  getNutritionDayById,
...
const dataObjectRegistry = {
  mealLog: {
    ...
    modelName: "MealLog",
    pluralName: "mealLogs",
    getById: getMealLogById,
    getIdList: getIdListOfMealLogByField,
    count: countMealLog,
  },
  mealLine: {
    name: "mealLine",
    modelName: "MealLine",
    pluralName: "mealLines",
    getById: getMealLineById,
    getIdList: getIdListOfMealLineByField,
    count: countMealLine,
  },
  nutritionDay: {
    name: "nutritionDay",
    modelName: "NutritionDay",
    pluralName: "nutritionDays",
    getById: getNutritionDayById,
    getIdList: getIdListOfNutritionDayByField,
    count: countNutritionDay,
  },
};
