...
const MODEL_REGISTRY = {
  mealLog: {
    modelName: "MealLog",
    objectName: "mealLog",
    schemaPath: "../../models/schemas/mealLog.schema",
    getModel: () => require("../../models").MealLog,
    getTableName: () => {
      try {
        const Model = require("../../models").MealLog;
        return Model?.getTableName?.() || "mealLog";
      } catch {
        return "mealLog";
      }
    },
  ...
  mealLine: {
    modelName: "MealLine",
    objectName: "mealLine",
    schemaPath: "../../models/schemas/mealLine.schema",
    getModel: () => require("../../models").MealLine,
    getTableName: () => {
      try {
        const Model = require("../../models").MealLine;
        return Model?.getTableName?.() || "mealLine";
      } catch {
        return "mealLine";
      }
    },
  ...
  nutritionDay: {
    ...
    schemaPath: "../../models/schemas/nutritionDay.schema",
    getModel: () => require("../../models").NutritionDay,
    getTableName: () => {
      try {
        const Model = require("../../models").NutritionDay;
        return Model?.getTableName?.() || "nutritionDay";
      } catch {
        return "nutritionDay";
      }
    },
