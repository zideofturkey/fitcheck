...
const m2mUpdateMealLineByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMealLineByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateMealLineByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateMealLineByQueryHandler;
