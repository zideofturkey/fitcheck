...
const m2mDeleteMealLogByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteMealLogByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteMealLogById(message);
    // log result
  } catch (err) {
...
module.exports = m2mDeleteMealLogByIdHandler;
