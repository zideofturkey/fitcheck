...
const m2mUpdateMealLineByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateMealLineByIdInvalidM2MToken",
    ...
    const result = await m2mUpdateMealLineById(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateMealLineById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateMealLineByIdRestController;
