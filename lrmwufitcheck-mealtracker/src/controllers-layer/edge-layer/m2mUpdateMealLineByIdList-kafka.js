...
const m2mUpdateMealLineByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMealLineByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateMealLineByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateMealLineByIdListHandler;
