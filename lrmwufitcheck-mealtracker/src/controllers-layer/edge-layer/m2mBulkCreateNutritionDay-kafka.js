...
const m2mBulkCreateNutritionDayHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateNutritionDayRequiresM2MToken",
    ...
    const result = await m2mBulkCreateNutritionDay(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateNutritionDayHandler;
