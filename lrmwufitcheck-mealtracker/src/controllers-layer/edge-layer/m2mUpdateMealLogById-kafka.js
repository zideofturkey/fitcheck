...
const m2mUpdateMealLogByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMealLogByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateMealLogById(message);
    // log result
  } catch (err) {
...
module.exports = m2mUpdateMealLogByIdHandler;
