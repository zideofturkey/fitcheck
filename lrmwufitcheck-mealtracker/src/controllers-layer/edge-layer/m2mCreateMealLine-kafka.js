...
const m2mCreateMealLineHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateMealLineRequiresM2MToken",
    ...
    const result = await m2mCreateMealLine(message);
    // log result
  } catch (err) {
...
module.exports = m2mCreateMealLineHandler;
