...
const m2mUpdateMealLogByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMealLogByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateMealLogByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateMealLogByIdListHandler;
