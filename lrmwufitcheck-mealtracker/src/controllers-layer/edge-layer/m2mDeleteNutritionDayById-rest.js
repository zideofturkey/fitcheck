...
const m2mDeleteNutritionDayByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteNutritionDayByIdInvalidM2MToken",
    ...
    const result = await m2mDeleteNutritionDayById(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteNutritionDayById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteNutritionDayByIdRestController;
