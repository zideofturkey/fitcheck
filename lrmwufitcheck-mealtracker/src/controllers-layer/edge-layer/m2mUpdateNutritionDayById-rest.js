...
const m2mUpdateNutritionDayByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateNutritionDayByIdInvalidM2MToken",
    ...
    const result = await m2mUpdateNutritionDayById(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateNutritionDayById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateNutritionDayByIdRestController;
