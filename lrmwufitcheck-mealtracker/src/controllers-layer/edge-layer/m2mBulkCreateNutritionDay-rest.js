...
const m2mBulkCreateNutritionDayRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreateNutritionDayInvalidM2MToken",
    ...
    const result = await m2mBulkCreateNutritionDay(req);
    ...
    console.error(
      "Error running routeService for m2mBulkCreateNutritionDay: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mBulkCreateNutritionDayRestController;
