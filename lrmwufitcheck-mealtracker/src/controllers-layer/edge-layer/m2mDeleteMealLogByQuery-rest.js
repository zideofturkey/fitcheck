...
const m2mDeleteMealLogByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteMealLogByQueryInvalidM2MToken",
    ...
    const result = await m2mDeleteMealLogByQuery(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteMealLogByQuery: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteMealLogByQueryRestController;
