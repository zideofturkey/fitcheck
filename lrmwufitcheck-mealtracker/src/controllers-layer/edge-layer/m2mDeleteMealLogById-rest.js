...
const m2mDeleteMealLogByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteMealLogByIdInvalidM2MToken",
    ...
    const result = await m2mDeleteMealLogById(req);
    ...
    console.error("Error running routeService for m2mDeleteMealLogById: ", err);
    return next(err);
  }
};

module.exports = m2mDeleteMealLogByIdRestController;
