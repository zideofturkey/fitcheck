...
const m2mBulkCreateMealLogHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateMealLogRequiresM2MToken",
    ...
    const result = await m2mBulkCreateMealLog(message);
    // log result
  } catch (err) {
...
module.exports = m2mBulkCreateMealLogHandler;
