...
const m2mDeleteMealLineByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteMealLineByIdInvalidM2MToken",
    ...
    const result = await m2mDeleteMealLineById(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteMealLineById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteMealLineByIdRestController;
