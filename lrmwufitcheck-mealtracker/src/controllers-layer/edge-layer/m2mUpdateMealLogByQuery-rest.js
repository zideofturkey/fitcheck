...
const m2mUpdateMealLogByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateMealLogByQueryInvalidM2MToken",
    ...
    const result = await m2mUpdateMealLogByQuery(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateMealLogByQuery: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateMealLogByQueryRestController;
