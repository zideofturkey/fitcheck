...
const m2mDeleteMealLineByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteMealLineByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteMealLineByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteMealLineByQueryHandler;
