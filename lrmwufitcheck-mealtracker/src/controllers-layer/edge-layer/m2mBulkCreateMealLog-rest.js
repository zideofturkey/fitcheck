...
const m2mBulkCreateMealLogRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreateMealLogInvalidM2MToken",
    ...
    const result = await m2mBulkCreateMealLog(req);
    ...
    console.error("Error running routeService for m2mBulkCreateMealLog: ", err);
    return next(err);
  }
};

module.exports = m2mBulkCreateMealLogRestController;
