...
const m2mUpdateMealLineByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMealLineByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateMealLineById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateMealLineByIdHandler;
