...
const m2mCreateNutritionDayHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateNutritionDayRequiresM2MToken",
    ...
    const result = await m2mCreateNutritionDay(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mCreateNutritionDayHandler;
