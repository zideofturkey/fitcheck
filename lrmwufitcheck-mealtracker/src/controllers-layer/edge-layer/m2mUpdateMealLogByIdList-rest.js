...
const m2mUpdateMealLogByIdListRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateMealLogByIdListInvalidM2MToken",
    ...
    const result = await m2mUpdateMealLogByIdList(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateMealLogByIdList: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateMealLogByIdListRestController;
