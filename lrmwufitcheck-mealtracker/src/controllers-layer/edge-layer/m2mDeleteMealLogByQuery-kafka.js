...
const m2mDeleteMealLogByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteMealLogByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteMealLogByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteMealLogByQueryHandler;
