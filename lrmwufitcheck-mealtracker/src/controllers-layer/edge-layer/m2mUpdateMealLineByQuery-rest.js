...
const m2mUpdateMealLineByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateMealLineByQueryInvalidM2MToken",
    ...
    const result = await m2mUpdateMealLineByQuery(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateMealLineByQuery: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateMealLineByQueryRestController;
