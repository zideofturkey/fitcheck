...
const m2mUpdateMealLogByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMealLogByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateMealLogByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateMealLogByQueryHandler;
