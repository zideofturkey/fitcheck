...
const m2mCreateNutritionDayRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mCreateNutritionDayInvalidM2MToken",
    ...
    const result = await m2mCreateNutritionDay(req);
    ...
    console.error(
      "Error running routeService for m2mCreateNutritionDay: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mCreateNutritionDayRestController;
