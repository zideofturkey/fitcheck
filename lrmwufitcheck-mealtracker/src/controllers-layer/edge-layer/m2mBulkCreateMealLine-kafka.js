...
const m2mBulkCreateMealLineHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateMealLineRequiresM2MToken",
    ...
    const result = await m2mBulkCreateMealLine(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateMealLineHandler;
