...
const m2mUpdateNutritionDayByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateNutritionDayByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateNutritionDayByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateNutritionDayByQueryHandler;
