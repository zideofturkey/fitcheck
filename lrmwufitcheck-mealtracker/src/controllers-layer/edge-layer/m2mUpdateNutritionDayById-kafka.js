...
const m2mUpdateNutritionDayByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateNutritionDayByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateNutritionDayById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateNutritionDayByIdHandler;
