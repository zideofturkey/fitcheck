...
const m2mUpdateMealLogByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateMealLogByIdInvalidM2MToken",
    ...
    const result = await m2mUpdateMealLogById(req);
    ...
    console.error("Error running routeService for m2mUpdateMealLogById: ", err);
    return next(err);
  }
};

module.exports = m2mUpdateMealLogByIdRestController;
