...
const m2mUpdateNutritionDayByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateNutritionDayByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateNutritionDayByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateNutritionDayByIdListHandler;
