...
const m2mBulkCreateMealLineRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreateMealLineInvalidM2MToken",
    ...
    const result = await m2mBulkCreateMealLine(req);
    ...
    console.error(
      "Error running routeService for m2mBulkCreateMealLine: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mBulkCreateMealLineRestController;
