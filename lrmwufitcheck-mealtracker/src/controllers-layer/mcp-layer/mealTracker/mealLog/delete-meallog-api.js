...
class DeleteMealLogMcpController extends MealTrackerServiceMcpController {
  constructor(params) {
    super("deleteMealLog", "deletemeallog", params);
    this.dataName = "mealLog";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteMealLogManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    description:
      ...
      requiredRolesMarker,
    requiredRoles,
    parameters: DeleteMealLogMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new DeleteMealLogMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return DeleteMealLogMcpController.getOutputSchema().parse(result);
