...
describe("weeklyAnalyticsView.aggregate", () => {
  let sandbox;
  let esStub;
  let mod; // module under test

  const MAIN_INDEX = "lrmwufitcheck_nutritionday";
  const STORED_INDEX = "lrmwufitcheck_weeklyanalyticsview";
  ...
  beforeEach(() => {
    ...
    mod = proxyquire("../../src/aggregates/weeklyAnalyticsView.aggregate", {
  ...
  // ==========================================================
  // STORED VIEW: weeklyAnalyticsViewAggregateData
  // ==========================================================
  it("weeklyAnalyticsViewAggregateData indexes enriched docs to stored index", async () => {
    const baseSource = {
      id: "p1",
    ...
    await mod.weeklyAnalyticsViewAggregateData("p1");
