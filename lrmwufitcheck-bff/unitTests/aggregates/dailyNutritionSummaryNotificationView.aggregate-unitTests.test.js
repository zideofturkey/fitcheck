...
describe("dailyNutritionSummaryNotificationView.aggregate", () => {
  let sandbox;
  let esStub;
  let mod; // module under test

  const MAIN_INDEX = "lrmwufitcheck_nutritionday";
  const STORED_INDEX = "lrmwufitcheck_dailynutritionsummarynotificationview";
  ...
  beforeEach(() => {
    ...
    mod = proxyquire(
      "../../src/aggregates/dailyNutritionSummaryNotificationView.aggregate",
      {
  ...
  // ==========================================================
  // STORED VIEW: dailyNutritionSummaryNotificationViewAggregateData
  // ==========================================================
  it("dailyNutritionSummaryNotificationViewAggregateData indexes enriched docs to stored index", async () => {
    const baseSource = {
      id: "p1",
      userId: "userIdVal",
    ...
    await mod.dailyNutritionSummaryNotificationViewAggregateData("p1");
  ...
  it("userProfileReDailyNutritionSummaryNotificationView re-enriches stored docs by child id", async () => {
    esStub.search
      .onCall(0)
      .resolves({
    ...
    await mod.userProfileReDailyNutritionSummaryNotificationView("child-1");
    expect(esStub.index.calledOnce).to.be.true;
