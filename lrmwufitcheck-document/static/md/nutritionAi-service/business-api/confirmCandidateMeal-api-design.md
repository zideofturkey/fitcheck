...
```js
runMScript(() => ({ id: this.aiCandidateMealId, userId: this.session.userId, isConfirmed: false, isCommitted: false }), {"path":"services[4].businessLogic[1].whereClause.fullWhereClause"})
```
