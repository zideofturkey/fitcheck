...
The event will be emitted to the `agentoverride-updated` Kafka Topic Note that the DB-Level events for `create`, `update` and `delete` operations will always be raised for internal reasons.
...
```js
runMScript(() => ({id:this.sys_agentOverrideId}), {"path":"services[5].businessLogic[3].whereClause.fullWhereClause"})
```
...
```js
{
  provider: runMScript(() => (this.provider), {"path":"services[5].businessLogic[3].dataClauseItems[0].value"}),
  model: runMScript(() => (this.model), {"path":"services[5].businessLogic[3].dataClauseItems[1].value"}),
  systemPrompt: runMScript(() => (this.systemPrompt), {"path":"services[5].businessLogic[3].dataClauseItems[2].value"}),
  temperature: runMScript(() => (this.temperature), {"path":"services[5].businessLogic[3].dataClauseItems[3].value"}),
  maxTokens: runMScript(() => (this.maxTokens), {"path":"services[5].businessLogic[3].dataClauseItems[4].value"}),
  responseFormat: runMScript(() => (this.responseFormat), {"path":"services[5].businessLogic[3].dataClauseItems[5].value"}),
  selectedTools: runMScript(() => (this.selectedTools), {"path":"services[5].businessLogic[3].dataClauseItems[6].value"}) === undefined ? undefined : (runMScript(() => (this.selectedTools), {"path":"services[5].businessLogic[3].dataClauseItems[6].value"}) ? (typeof runMScript(() => (this.selectedTools), {"path":"services[5].businessLogic[3].dataClauseItems[6].value"}) == 'string' ? JSON.parse(runMScript(() => (this.selectedTools), {"path":"services[5].businessLogic[3].dataClauseItems[6].value"})) : runMScript(() => (this.selectedTools), {"path":"services[5].businessLogic[3].dataClauseItems[6].value"})) : null),
  guardrails: runMScript(() => (this.guardrails), {"path":"services[5].businessLogic[3].dataClauseItems[7].value"}) === undefined ? undefined : (runMScript(() => (this.guardrails), {"path":"services[5].businessLogic[3].dataClauseItems[7].value"}) ? (typeof runMScript(() => (this.guardrails), {"path":"services[5].businessLogic[3].dataClauseItems[7].value"}) == 'string' ? JSON.parse(runMScript(() => (this.guardrails), {"path":"services[5].businessLogic[3].dataClauseItems[7].value"})) : runMScript(() => (this.guardrails), {"path":"services[5].businessLogic[3].dataClauseItems[7].value"})) : null),
  enabled: runMScript(() => (this.enabled), {"path":"services[5].businessLogic[3].dataClauseItems[8].value"}),
}
```
