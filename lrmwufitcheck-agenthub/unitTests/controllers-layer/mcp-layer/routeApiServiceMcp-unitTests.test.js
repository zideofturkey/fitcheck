...
describe("GetAgentOverrideMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/sys_agentOverride/get-agentoverride-api.js",
      {
        apiLayer: { GetAgentOverrideManager: ManagerStub },
        "../../AgentHubServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("getAgentOverride");
