...
// This script is called from the ListAgentChatsManager
...
const dbScriptListAgentchats = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListAgentchats",
      {
...
module.exports = dbScriptListAgentchats;
