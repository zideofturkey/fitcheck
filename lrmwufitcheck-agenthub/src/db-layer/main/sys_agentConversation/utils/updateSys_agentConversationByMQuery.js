...
/**
 * Updates all Sys_agentConversation records matching an MScript Query.
 ...
 */
const updateSys_agentConversationByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingSys_agentConversationByMQuery",
      err,
    );
  }
};

module.exports = updateSys_agentConversationByMQuery;
