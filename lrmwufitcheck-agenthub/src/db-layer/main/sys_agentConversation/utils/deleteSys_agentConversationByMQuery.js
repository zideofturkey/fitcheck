...
/**
 * Deletes all Sys_agentConversation records matching an MScript Query.
 ...
 */
const deleteSys_agentConversationByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingSys_agentConversationByMQuery",
      err,
    );
  }
};

module.exports = deleteSys_agentConversationByMQuery;
