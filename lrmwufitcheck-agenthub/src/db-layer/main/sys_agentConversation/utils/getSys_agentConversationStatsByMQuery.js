...
/**
 * Calculates statistics on Sys_agentConversation records matching an MScript Query.
 ...
 */
const getSys_agentConversationStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingSys_agentConversationStatsByMQuery",
      err,
    );
  }
};

module.exports = getSys_agentConversationStatsByMQuery;
