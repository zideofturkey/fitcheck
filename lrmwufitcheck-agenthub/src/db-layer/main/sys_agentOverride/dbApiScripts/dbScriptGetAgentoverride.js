...
// This script is called from the GetAgentOverrideManager
...
const dbScriptGetAgentoverride = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Sys_agentOverride.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetAgentoverride",
      {
...
module.exports = dbScriptGetAgentoverride;
