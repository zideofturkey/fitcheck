...
// This script is called from the DeleteAgentOverrideManager
...
const dbScriptDeleteAgentoverride = async (apiManager) => {
  ...
  try {
    const res = await Sys_agentOverride.destroy({ where: instanceWhereClause });
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteAgentoverride",
      {
...
module.exports = dbScriptDeleteAgentoverride;
