...
// This script is called from the ListAgentOverridesManager
...
const dbScriptListAgentoverrides = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListAgentoverrides",
      {
...
module.exports = dbScriptListAgentoverrides;
