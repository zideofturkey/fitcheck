...
/**
 * @deprecated Use updateSys_agentOverrideByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateSys_agentOverrideByQuery = async (
  dataClause,
  query,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingSys_agentOverrideByQuery",
      err,
    );
  }
};

module.exports = updateSys_agentOverrideByQuery;
