...
/**
 * Updates all Sys_agentOverride records matching an MScript Query.
 ...
 */
const updateSys_agentOverrideByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingSys_agentOverrideByMQuery",
      err,
    );
  }
};

module.exports = updateSys_agentOverrideByMQuery;
