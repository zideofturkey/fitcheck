...
/**
 * Calculates statistics on Sys_agentOverride records matching an MScript Query.
 ...
 */
const getSys_agentOverrideStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingSys_agentOverrideStatsByMQuery",
      err,
    );
  }
};

module.exports = getSys_agentOverrideStatsByMQuery;
