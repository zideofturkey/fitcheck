...
/**
 * @deprecated Use updateSys_toolCatalogByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateSys_toolCatalogByQuery = async (
  dataClause,
  query,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingSys_toolCatalogByQuery",
      err,
    );
  }
};

module.exports = updateSys_toolCatalogByQuery;
