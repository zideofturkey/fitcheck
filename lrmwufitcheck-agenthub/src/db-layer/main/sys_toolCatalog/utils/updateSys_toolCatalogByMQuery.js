...
/**
 * Updates all Sys_toolCatalog records matching an MScript Query.
 ...
 */
const updateSys_toolCatalogByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingSys_toolCatalogByMQuery",
      err,
    );
  }
};

module.exports = updateSys_toolCatalogByMQuery;
