...
/**
 * Calculates statistics on Sys_toolCatalog records matching an MScript Query.
 ...
 */
const getSys_toolCatalogStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingSys_toolCatalogStatsByMQuery",
      err,
    );
  }
};

module.exports = getSys_toolCatalogStatsByMQuery;
