...
// This script is called from the ListToolCatalogManager
...
const dbScriptListToolcatalog = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListToolcatalog",
      {
...
module.exports = dbScriptListToolcatalog;
