...
/**
 * @deprecated Use updateSys_agentExecutionByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateSys_agentExecutionByQuery = async (
  dataClause,
  query,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingSys_agentExecutionByQuery",
      err,
    );
  }
};

module.exports = updateSys_agentExecutionByQuery;
