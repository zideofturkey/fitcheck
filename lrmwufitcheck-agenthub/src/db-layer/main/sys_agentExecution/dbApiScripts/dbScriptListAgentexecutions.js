...
// This script is called from the ListAgentExecutionsManager
...
const dbScriptListAgentexecutions = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListAgentexecutions",
      {
...
module.exports = dbScriptListAgentexecutions;
