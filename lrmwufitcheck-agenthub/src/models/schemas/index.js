...
const schemas = {
  sys_agentOverride: require("./sys_agentOverride.schema"),
  sys_agentExecution: require("./sys_agentExecution.schema"),
  sys_toolCatalog: require("./sys_toolCatalog.schema"),
  sys_agentConversation: require("./sys_agentConversation.schema"),
};
