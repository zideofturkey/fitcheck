...
const dataObjectRegistry = {
  sys_agentOverride: {
    ...
    pluralName: "sys_agentOverrides",
    getById: getSys_agentOverrideById,
    getIdList: getIdListOfSys_agentOverrideByField,
    count: countSys_agentOverride,
  },
  sys_agentExecution: {
    name: "sys_agentExecution",
    modelName: "Sys_agentExecution",
    pluralName: "sys_agentExecutions",
    getById: getSys_agentExecutionById,
    getIdList: getIdListOfSys_agentExecutionByField,
    count: countSys_agentExecution,
  },
  sys_toolCatalog: {
    name: "sys_toolCatalog",
    modelName: "Sys_toolCatalog",
    pluralName: "sys_toolCatalogs",
    getById: getSys_toolCatalogById,
    getIdList: getIdListOfSys_toolCatalogByField,
    count: countSys_toolCatalog,
  },
  sys_agentConversation: {
    name: "sys_agentConversation",
    modelName: "Sys_agentConversation",
    pluralName: "sys_agentConversations",
    getById: getSys_agentConversationById,
    getIdList: getIdListOfSys_agentConversationByField,
    count: countSys_agentConversation,
  },
};
