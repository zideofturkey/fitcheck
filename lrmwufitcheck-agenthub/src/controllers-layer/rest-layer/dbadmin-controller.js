...
const MODEL_REGISTRY = {
  sys_agentOverride: {
    ...
    schemaPath: "../../models/schemas/sys_agentOverride.schema",
    getModel: () => require("../../models").Sys_agentOverride,
    getTableName: () => {
      try {
        const Model = require("../../models").Sys_agentOverride;
        return Model?.getTableName?.() || "sys_agentOverride";
      } catch {
        return "sys_agentOverride";
      }
    },
  },
  sys_agentExecution: {
    ...
    schemaPath: "../../models/schemas/sys_agentExecution.schema",
    getModel: () => require("../../models").Sys_agentExecution,
    getTableName: () => {
      try {
        const Model = require("../../models").Sys_agentExecution;
        return Model?.getTableName?.() || "sys_agentExecution";
      } catch {
        return "sys_agentExecution";
      }
    },
  },
  sys_toolCatalog: {
    ...
    schemaPath: "../../models/schemas/sys_toolCatalog.schema",
    getModel: () => require("../../models").Sys_toolCatalog,
    getTableName: () => {
      try {
        const Model = require("../../models").Sys_toolCatalog;
        return Model?.getTableName?.() || "sys_toolCatalog";
      } catch {
        return "sys_toolCatalog";
      }
    },
  },
  sys_agentConversation: {
    ...
    schemaPath: "../../models/schemas/sys_agentConversation.schema",
    getModel: () => require("../../models").Sys_agentConversation,
    getTableName: () => {
      try {
        const Model = require("../../models").Sys_agentConversation;
        return Model?.getTableName?.() || "sys_agentConversation";
      } catch {
        return "sys_agentConversation";
      }
    },
  },
};
