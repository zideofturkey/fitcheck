...
const m2mCreateSys_toolCatalogHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateSys_toolCatalogRequiresM2MToken",
    ...
    const result = await m2mCreateSys_toolCatalog(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mCreateSys_toolCatalogHandler;
