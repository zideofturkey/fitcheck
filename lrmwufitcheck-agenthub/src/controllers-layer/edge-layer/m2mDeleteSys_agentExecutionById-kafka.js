...
const { m2mDeleteSys_agentExecutionById } = require("edgeFunctions");

const m2mDeleteSys_agentExecutionByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteSys_agentExecutionByIdInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteSys_agentExecutionByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteSys_agentExecutionById(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mDeleteSys_agentExecutionById: ",
      err,
    );
    // log error
  }
...
module.exports = m2mDeleteSys_agentExecutionByIdHandler;
