...
const { m2mDeleteSys_agentConversationByQuery } = require("edgeFunctions");

const m2mDeleteSys_agentConversationByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteSys_agentConversationByQueryInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteSys_agentConversationByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteSys_agentConversationByQuery(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mDeleteSys_agentConversationByQuery: ",
      err,
    );
    // log error
  }
...
module.exports = m2mDeleteSys_agentConversationByQueryHandler;
