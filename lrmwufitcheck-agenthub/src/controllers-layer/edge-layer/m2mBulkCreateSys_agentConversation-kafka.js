...
const { m2mBulkCreateSys_agentConversation } = require("edgeFunctions");

const m2mBulkCreateSys_agentConversationHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreateSys_agentConversationInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateSys_agentConversationRequiresM2MToken",
    ...
    const result = await m2mBulkCreateSys_agentConversation(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mBulkCreateSys_agentConversation: ",
      err,
    );
    // log error
  }
...
module.exports = m2mBulkCreateSys_agentConversationHandler;
