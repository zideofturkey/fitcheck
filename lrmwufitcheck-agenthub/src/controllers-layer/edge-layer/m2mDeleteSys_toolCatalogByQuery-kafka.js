...
const m2mDeleteSys_toolCatalogByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteSys_toolCatalogByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteSys_toolCatalogByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteSys_toolCatalogByQueryHandler;
