...
const { m2mUpdateSys_agentExecutionByIdList } = require("edgeFunctions");

const m2mUpdateSys_agentExecutionByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateSys_agentExecutionByIdListInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateSys_agentExecutionByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateSys_agentExecutionByIdList(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mUpdateSys_agentExecutionByIdList: ",
      err,
    );
    // log error
  }
...
module.exports = m2mUpdateSys_agentExecutionByIdListHandler;
