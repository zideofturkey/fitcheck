...
const m2mUpdateSys_agentOverrideByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateSys_agentOverrideByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateSys_agentOverrideById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateSys_agentOverrideByIdHandler;
