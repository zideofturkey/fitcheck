...
const m2mUpdateSys_toolCatalogByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateSys_toolCatalogByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateSys_toolCatalogById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateSys_toolCatalogByIdHandler;
