...
const m2mUpdateSys_toolCatalogByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateSys_toolCatalogByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateSys_toolCatalogByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateSys_toolCatalogByIdListHandler;
