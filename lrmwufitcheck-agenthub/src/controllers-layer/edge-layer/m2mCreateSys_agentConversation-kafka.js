...
const m2mCreateSys_agentConversationHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateSys_agentConversationRequiresM2MToken",
    ...
    const result = await m2mCreateSys_agentConversation(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mCreateSys_agentConversationHandler;
