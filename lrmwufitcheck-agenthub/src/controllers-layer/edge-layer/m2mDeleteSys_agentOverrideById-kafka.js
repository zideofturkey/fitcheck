...
const m2mDeleteSys_agentOverrideByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteSys_agentOverrideByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteSys_agentOverrideById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteSys_agentOverrideByIdHandler;
