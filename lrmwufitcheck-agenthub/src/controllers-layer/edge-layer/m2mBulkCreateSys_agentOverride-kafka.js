...
const m2mBulkCreateSys_agentOverrideHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateSys_agentOverrideRequiresM2MToken",
    ...
    const result = await m2mBulkCreateSys_agentOverride(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateSys_agentOverrideHandler;
