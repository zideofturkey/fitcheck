...
const { m2mUpdateSys_agentConversationByIdList } = require("edgeFunctions");

const m2mUpdateSys_agentConversationByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateSys_agentConversationByIdListInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateSys_agentConversationByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateSys_agentConversationByIdList(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mUpdateSys_agentConversationByIdList: ",
      err,
    );
    // log error
  }
...
module.exports = m2mUpdateSys_agentConversationByIdListHandler;
