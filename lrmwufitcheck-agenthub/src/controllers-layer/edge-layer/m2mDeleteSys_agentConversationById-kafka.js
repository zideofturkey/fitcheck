...
const m2mDeleteSys_agentConversationByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteSys_agentConversationByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteSys_agentConversationById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteSys_agentConversationByIdHandler;
