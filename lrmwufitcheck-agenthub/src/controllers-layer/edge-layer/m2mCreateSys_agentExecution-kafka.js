...
const m2mCreateSys_agentExecutionHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateSys_agentExecutionRequiresM2MToken",
    ...
    const result = await m2mCreateSys_agentExecution(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mCreateSys_agentExecutionHandler;
