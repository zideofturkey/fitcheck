...
const m2mBulkCreateSys_toolCatalogHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateSys_toolCatalogRequiresM2MToken",
    ...
    const result = await m2mBulkCreateSys_toolCatalog(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateSys_toolCatalogHandler;
