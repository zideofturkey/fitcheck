...
const m2mDeleteSys_toolCatalogByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteSys_toolCatalogByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteSys_toolCatalogById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteSys_toolCatalogByIdHandler;
