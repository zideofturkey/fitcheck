...
const m2mDeleteSys_agentExecutionByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteSys_agentExecutionByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteSys_agentExecutionByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteSys_agentExecutionByQueryHandler;
