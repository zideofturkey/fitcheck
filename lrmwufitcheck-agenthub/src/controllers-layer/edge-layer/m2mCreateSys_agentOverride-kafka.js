...
const m2mCreateSys_agentOverrideHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateSys_agentOverrideRequiresM2MToken",
    ...
    const result = await m2mCreateSys_agentOverride(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mCreateSys_agentOverrideHandler;
