...
class GetAgentOverrideMcpController extends AgentHubServiceMcpController {
  constructor(params) {
    super("getAgentOverride", "getagentoverride", params);
    this.dataName = "sys_agentOverride";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetAgentOverrideManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    requiredRoles,
    parameters: GetAgentOverrideMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetAgentOverrideMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetAgentOverrideMcpController.getOutputSchema().parse(result);
