...
class DeleteAgentOverrideMcpController extends AgentHubServiceMcpController {
  constructor(params) {
    super("deleteAgentOverride", "deleteagentoverride", params);
    this.dataName = "sys_agentOverride";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteAgentOverrideManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    requiredRoles,
    parameters: DeleteAgentOverrideMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new DeleteAgentOverrideMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return DeleteAgentOverrideMcpController.getOutputSchema().parse(result);
