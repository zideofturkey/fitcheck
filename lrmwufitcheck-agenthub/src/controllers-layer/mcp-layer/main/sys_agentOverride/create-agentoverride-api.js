...
class CreateAgentOverrideMcpController extends AgentHubServiceMcpController {
  constructor(params) {
    super("createAgentOverride", "createagentoverride", params);
    this.dataName = "sys_agentOverride";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreateAgentOverrideManager(this.request, "mcp");
  }
  ...
  static getInputScheme() {
    return {
      ...
      enabled: z
        .boolean()
        .optional()
        .describe("Optional caller override; defaults to true when omitted."),
    };
  }
}
...
module.exports = (headers) => {
  ...
  return {
    ...
    requiredRoles,
    parameters: CreateAgentOverrideMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CreateAgentOverrideMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CreateAgentOverrideMcpController.getOutputSchema().parse(result);
