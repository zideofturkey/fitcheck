...
class ListAgentOverridesMcpController extends AgentHubServiceMcpController {
  constructor(params) {
    super("listAgentOverrides", "listagentoverrides", params);
    this.dataName = "sys_agentOverrides";
    this.crudType = "list";
  }

  createApiManager() {
    return new ListAgentOverridesManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    requiredRoles,
    parameters: ListAgentOverridesMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new ListAgentOverridesMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return ListAgentOverridesMcpController.getOutputSchema().parse(result);
