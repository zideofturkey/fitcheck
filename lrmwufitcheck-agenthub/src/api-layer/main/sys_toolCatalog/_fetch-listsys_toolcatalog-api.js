...
const { dbScript_fetchListsys_toolcatalog } = require("dbLayer");
...
class _fetchListSys_toolCatalogManager extends Sys_toolCatalogManager {
  ...
  async executeMainOperation() {
    return await dbScript_fetchListsys_toolcatalog(this);
...
module.exports = _fetchListSys_toolCatalogManager;
