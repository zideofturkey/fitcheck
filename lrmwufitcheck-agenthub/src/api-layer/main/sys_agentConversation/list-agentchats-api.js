...
const { dbScriptListAgentchats } = require("dbLayer");
...
const { AgentchatsListedPublisher } = require("../../api-events/publishers");

// use this object to access db utils functions with in Mscript or actions
const db = require("dbLayer");

class ListAgentChatsManager extends Sys_agentConversationManager {
  ...
  async executeMainOperation() {
    return await dbScriptListAgentchats(this);
  ...
  async raiseEvent() {
    AgentchatsListedPublisher.Publish(this.output, this.session).catch(
      (err) => {
...
module.exports = ListAgentChatsManager;
