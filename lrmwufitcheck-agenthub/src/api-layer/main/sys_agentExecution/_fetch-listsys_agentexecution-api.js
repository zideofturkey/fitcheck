...
const { dbScript_fetchListsys_agentexecution } = require("dbLayer");
...
class _fetchListSys_agentExecutionManager extends Sys_agentExecutionManager {
  ...
  async executeMainOperation() {
    return await dbScript_fetchListsys_agentexecution(this);
...
module.exports = _fetchListSys_agentExecutionManager;
