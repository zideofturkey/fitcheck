...
console.log("Starting fitcheck-nutritionlibrary-service service...");
...
const start = async () => {
  process.title = "node-lrmwufitcheck-nutritionlibrary-service";
  ...
  try {
    ...
    await setRedisData(
      "lrmwufitcheck-nutritionlibrary-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key lrmwufitcheck-nutritionlibrary-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "fitcheck-nutritionlibrary-service is listening HTTP/REST port " +
...
/* starting the server fitcheck-nutritionlibrary-service .... */
start();
