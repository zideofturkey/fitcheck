...
const MODEL_REGISTRY = {
  macroTarget: {
    ...
    schemaPath: "../../models/schemas/macroTarget.schema",
    getModel: () => require("../../models").MacroTarget,
    getTableName: () => {
      try {
        const Model = require("../../models").MacroTarget;
        return Model?.getTableName?.() || "macroTarget";
      } catch {
        return "macroTarget";
      }
    },
  ...
  foodItem: {
    modelName: "FoodItem",
    objectName: "foodItem",
    schemaPath: "../../models/schemas/foodItem.schema",
    getModel: () => require("../../models").FoodItem,
    getTableName: () => {
      try {
        const Model = require("../../models").FoodItem;
        return Model?.getTableName?.() || "foodItem";
      } catch {
        return "foodItem";
      }
    },
  ...
  presetMeal: {
    ...
    schemaPath: "../../models/schemas/presetMeal.schema",
    getModel: () => require("../../models").PresetMeal,
    getTableName: () => {
      try {
        const Model = require("../../models").PresetMeal;
        return Model?.getTableName?.() || "presetMeal";
      } catch {
        return "presetMeal";
      }
    },
  ...
  presetLine: {
    ...
    schemaPath: "../../models/schemas/presetLine.schema",
    getModel: () => require("../../models").PresetLine,
    getTableName: () => {
      try {
        const Model = require("../../models").PresetLine;
        return Model?.getTableName?.() || "presetLine";
      } catch {
        return "presetLine";
      }
    },
