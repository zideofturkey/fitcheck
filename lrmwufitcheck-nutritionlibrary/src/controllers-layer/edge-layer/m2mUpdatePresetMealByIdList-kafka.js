...
const m2mUpdatePresetMealByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdatePresetMealByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdatePresetMealByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdatePresetMealByIdListHandler;
