...
const m2mDeletePresetLineByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeletePresetLineByIdRequiresM2MToken",
    ...
    const result = await m2mDeletePresetLineById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeletePresetLineByIdHandler;
