...
const m2mUpdatePresetLineByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdatePresetLineByIdRequiresM2MToken",
    ...
    const result = await m2mUpdatePresetLineById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdatePresetLineByIdHandler;
