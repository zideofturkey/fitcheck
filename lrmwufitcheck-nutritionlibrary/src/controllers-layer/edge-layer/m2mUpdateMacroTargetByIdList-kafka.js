...
const m2mUpdateMacroTargetByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMacroTargetByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateMacroTargetByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateMacroTargetByIdListHandler;
