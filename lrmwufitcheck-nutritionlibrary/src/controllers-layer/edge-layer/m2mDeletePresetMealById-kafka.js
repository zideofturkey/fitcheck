...
const m2mDeletePresetMealByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeletePresetMealByIdRequiresM2MToken",
    ...
    const result = await m2mDeletePresetMealById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeletePresetMealByIdHandler;
