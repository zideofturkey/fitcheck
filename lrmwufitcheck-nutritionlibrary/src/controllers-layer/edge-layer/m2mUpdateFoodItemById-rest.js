...
const m2mUpdateFoodItemByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateFoodItemByIdInvalidM2MToken",
    ...
    const result = await m2mUpdateFoodItemById(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateFoodItemById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateFoodItemByIdRestController;
