...
const m2mUpdatePresetMealByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdatePresetMealByIdRequiresM2MToken",
    ...
    const result = await m2mUpdatePresetMealById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdatePresetMealByIdHandler;
