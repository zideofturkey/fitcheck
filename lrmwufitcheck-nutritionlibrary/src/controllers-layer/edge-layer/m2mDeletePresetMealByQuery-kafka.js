...
const m2mDeletePresetMealByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeletePresetMealByQueryRequiresM2MToken",
    ...
    const result = await m2mDeletePresetMealByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeletePresetMealByQueryHandler;
