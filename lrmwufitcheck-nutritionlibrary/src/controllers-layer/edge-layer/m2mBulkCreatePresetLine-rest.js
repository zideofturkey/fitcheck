...
const m2mBulkCreatePresetLineRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreatePresetLineInvalidM2MToken",
    ...
    const result = await m2mBulkCreatePresetLine(req);
    ...
    console.error(
      "Error running routeService for m2mBulkCreatePresetLine: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mBulkCreatePresetLineRestController;
