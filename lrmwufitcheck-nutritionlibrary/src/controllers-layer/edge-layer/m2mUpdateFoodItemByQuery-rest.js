...
const m2mUpdateFoodItemByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateFoodItemByQueryInvalidM2MToken",
    ...
    const result = await m2mUpdateFoodItemByQuery(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateFoodItemByQuery: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateFoodItemByQueryRestController;
