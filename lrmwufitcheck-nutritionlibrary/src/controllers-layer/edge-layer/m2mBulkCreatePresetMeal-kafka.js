...
const m2mBulkCreatePresetMealHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreatePresetMealRequiresM2MToken",
    ...
    const result = await m2mBulkCreatePresetMeal(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreatePresetMealHandler;
