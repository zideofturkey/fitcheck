...
const m2mDeleteMacroTargetByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteMacroTargetByIdInvalidM2MToken",
    ...
    const result = await m2mDeleteMacroTargetById(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteMacroTargetById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteMacroTargetByIdRestController;
