...
const m2mDeleteFoodItemByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteFoodItemByQueryInvalidM2MToken",
    ...
    const result = await m2mDeleteFoodItemByQuery(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteFoodItemByQuery: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteFoodItemByQueryRestController;
