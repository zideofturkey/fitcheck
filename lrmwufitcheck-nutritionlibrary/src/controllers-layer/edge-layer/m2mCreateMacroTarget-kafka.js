...
const m2mCreateMacroTargetHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateMacroTargetRequiresM2MToken",
    ...
    const result = await m2mCreateMacroTarget(message);
    // log result
  } catch (err) {
...
module.exports = m2mCreateMacroTargetHandler;
