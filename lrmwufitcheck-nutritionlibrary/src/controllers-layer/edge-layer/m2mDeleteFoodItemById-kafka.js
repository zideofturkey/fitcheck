...
const m2mDeleteFoodItemByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteFoodItemByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteFoodItemById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteFoodItemByIdHandler;
