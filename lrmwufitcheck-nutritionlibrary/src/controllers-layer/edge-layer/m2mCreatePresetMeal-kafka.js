...
const m2mCreatePresetMealHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreatePresetMealRequiresM2MToken",
    ...
    const result = await m2mCreatePresetMeal(message);
    // log result
  } catch (err) {
...
module.exports = m2mCreatePresetMealHandler;
