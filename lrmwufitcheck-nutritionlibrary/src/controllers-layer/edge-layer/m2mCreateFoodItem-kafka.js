...
const m2mCreateFoodItemHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateFoodItemRequiresM2MToken",
    ...
    const result = await m2mCreateFoodItem(message);
    // log result
  } catch (err) {
...
module.exports = m2mCreateFoodItemHandler;
