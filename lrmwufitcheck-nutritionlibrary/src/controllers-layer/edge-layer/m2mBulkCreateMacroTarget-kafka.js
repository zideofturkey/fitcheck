...
const m2mBulkCreateMacroTargetHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateMacroTargetRequiresM2MToken",
    ...
    const result = await m2mBulkCreateMacroTarget(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateMacroTargetHandler;
