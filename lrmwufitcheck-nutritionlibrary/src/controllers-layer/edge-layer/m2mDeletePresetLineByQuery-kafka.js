...
const m2mDeletePresetLineByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeletePresetLineByQueryRequiresM2MToken",
    ...
    const result = await m2mDeletePresetLineByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeletePresetLineByQueryHandler;
