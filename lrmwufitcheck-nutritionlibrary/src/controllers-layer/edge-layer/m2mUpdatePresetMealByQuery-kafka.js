...
const m2mUpdatePresetMealByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdatePresetMealByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdatePresetMealByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdatePresetMealByQueryHandler;
