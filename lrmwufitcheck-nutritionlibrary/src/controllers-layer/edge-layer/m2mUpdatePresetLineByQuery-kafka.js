...
const m2mUpdatePresetLineByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdatePresetLineByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdatePresetLineByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdatePresetLineByQueryHandler;
