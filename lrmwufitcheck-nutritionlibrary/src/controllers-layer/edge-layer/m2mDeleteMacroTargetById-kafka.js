...
const m2mDeleteMacroTargetByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteMacroTargetByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteMacroTargetById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteMacroTargetByIdHandler;
