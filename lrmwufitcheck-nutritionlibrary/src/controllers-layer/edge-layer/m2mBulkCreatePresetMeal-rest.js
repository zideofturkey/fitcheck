...
const m2mBulkCreatePresetMealRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreatePresetMealInvalidM2MToken",
    ...
    const result = await m2mBulkCreatePresetMeal(req);
    ...
    console.error(
      "Error running routeService for m2mBulkCreatePresetMeal: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mBulkCreatePresetMealRestController;
