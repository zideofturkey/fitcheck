...
const m2mBulkCreateFoodItemHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateFoodItemRequiresM2MToken",
    ...
    const result = await m2mBulkCreateFoodItem(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateFoodItemHandler;
