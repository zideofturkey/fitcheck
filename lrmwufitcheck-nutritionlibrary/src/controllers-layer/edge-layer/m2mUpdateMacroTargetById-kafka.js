...
const m2mUpdateMacroTargetByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMacroTargetByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateMacroTargetById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateMacroTargetByIdHandler;
