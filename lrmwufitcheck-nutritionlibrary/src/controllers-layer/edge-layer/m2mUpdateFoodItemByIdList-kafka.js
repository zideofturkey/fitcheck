...
const m2mUpdateFoodItemByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateFoodItemByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateFoodItemByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateFoodItemByIdListHandler;
