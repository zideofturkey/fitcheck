...
const m2mUpdatePresetLineByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdatePresetLineByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdatePresetLineByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdatePresetLineByIdListHandler;
