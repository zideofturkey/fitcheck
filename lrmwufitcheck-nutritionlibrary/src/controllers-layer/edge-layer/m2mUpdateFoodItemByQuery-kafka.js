...
const m2mUpdateFoodItemByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateFoodItemByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateFoodItemByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateFoodItemByQueryHandler;
