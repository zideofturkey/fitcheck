...
const m2mUpdateMacroTargetByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateMacroTargetByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateMacroTargetByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateMacroTargetByQueryHandler;
