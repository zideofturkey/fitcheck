...
const m2mUpdatePresetMealByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdatePresetMealByIdInvalidM2MToken",
    ...
    const result = await m2mUpdatePresetMealById(req);
    ...
    console.error(
      "Error running routeService for m2mUpdatePresetMealById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdatePresetMealByIdRestController;
