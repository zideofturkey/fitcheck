...
const m2mDeleteFoodItemByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteFoodItemByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteFoodItemByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteFoodItemByQueryHandler;
