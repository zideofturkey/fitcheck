...
const m2mDeleteFoodItemByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteFoodItemByIdInvalidM2MToken",
    ...
    const result = await m2mDeleteFoodItemById(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteFoodItemById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteFoodItemByIdRestController;
