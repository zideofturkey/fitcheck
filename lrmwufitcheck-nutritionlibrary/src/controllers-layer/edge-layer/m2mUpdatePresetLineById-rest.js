...
const m2mUpdatePresetLineByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdatePresetLineByIdInvalidM2MToken",
    ...
    const result = await m2mUpdatePresetLineById(req);
    ...
    console.error(
      "Error running routeService for m2mUpdatePresetLineById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdatePresetLineByIdRestController;
