...
const m2mDeleteMacroTargetByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteMacroTargetByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteMacroTargetByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteMacroTargetByQueryHandler;
