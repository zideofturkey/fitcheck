...
const m2mBulkCreatePresetLineHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreatePresetLineRequiresM2MToken",
    ...
    const result = await m2mBulkCreatePresetLine(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreatePresetLineHandler;
