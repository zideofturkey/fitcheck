...
const m2mBulkCreateFoodItemRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreateFoodItemInvalidM2MToken",
    ...
    const result = await m2mBulkCreateFoodItem(req);
    ...
    console.error(
      "Error running routeService for m2mBulkCreateFoodItem: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mBulkCreateFoodItemRestController;
