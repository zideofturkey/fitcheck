...
const m2mUpdateFoodItemByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateFoodItemByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateFoodItemById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateFoodItemByIdHandler;
