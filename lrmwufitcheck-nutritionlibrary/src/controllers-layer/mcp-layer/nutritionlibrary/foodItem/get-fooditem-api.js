...
class GetFoodItemMcpController extends NutritionLibraryServiceMcpController {
  constructor(params) {
    super("getFoodItem", "getfooditem", params);
    this.dataName = "foodItem";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetFoodItemManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    description:
      ...
      requiredRolesMarker,
    requiredRoles,
    parameters: GetFoodItemMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetFoodItemMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetFoodItemMcpController.getOutputSchema().parse(result);
