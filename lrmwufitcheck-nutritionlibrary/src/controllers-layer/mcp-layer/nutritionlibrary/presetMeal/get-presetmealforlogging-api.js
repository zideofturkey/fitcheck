...
class GetPresetMealForLoggingMcpController extends NutritionLibraryServiceMcpController {
  constructor(params) {
    super("getPresetMealForLogging", "getpresetmealforlogging", params);
    this.dataName = "presetMeal";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetPresetMealForLoggingManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    description:
      ...
      requiredRolesMarker,
    requiredRoles,
    parameters: GetPresetMealForLoggingMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetPresetMealForLoggingMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetPresetMealForLoggingMcpController.getOutputSchema().parse(result);
