...
class CreatePresetMealMcpController extends NutritionLibraryServiceMcpController {
  constructor(params) {
    super("createPresetMeal", "createpresetmeal", params);
    this.dataName = "presetMeal";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreatePresetMealManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    description:
      ...
      requiredRolesMarker,
    requiredRoles,
    parameters: CreatePresetMealMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CreatePresetMealMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CreatePresetMealMcpController.getOutputSchema().parse(result);
