...
class DeleteDishMcpController extends NutritionLibraryServiceMcpController {
  constructor(params) {
    super("deleteDish", "deletedish", params);
    this.dataName = "dish";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteDishManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    name: "deleteDish",
    description:
      "Soft-delete a dish and all its lines. Ownership enforced." +
      requiredRolesMarker,
    requiredRoles,
    parameters: DeleteDishMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new DeleteDishMcpController(mcpParams);
      try {
