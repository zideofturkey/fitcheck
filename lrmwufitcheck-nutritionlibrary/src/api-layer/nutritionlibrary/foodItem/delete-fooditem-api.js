...
const { dbScriptDeleteFooditem } = require("dbLayer");
...
class DeleteFoodItemManager extends FoodItemManager {
  ...
  async getRouteQuery() {
    return runMScript(
      ...
      { path: "services[2].businessLogic[6].whereClause.fullWhereClause" },
    );
  ...
  async executeMainOperation() {
    return await dbScriptDeleteFooditem(this);
...
module.exports = DeleteFoodItemManager;
