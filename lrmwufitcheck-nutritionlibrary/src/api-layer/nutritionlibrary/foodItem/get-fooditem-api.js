...
const { dbScriptGetFooditem } = require("dbLayer");
...
class GetFoodItemManager extends FoodItemManager {
  ...
  async getRouteQuery() {
    return runMScript(
      ...
      { path: "services[2].businessLogic[3].whereClause.fullWhereClause" },
    );
  ...
  async executeMainOperation() {
    return await dbScriptGetFooditem(this);
...
module.exports = GetFoodItemManager;
