...
const { dbScriptGetMymacrotarget } = require("dbLayer");
...
class GetMyMacroTargetManager extends MacroTargetManager {
  ...
  async getRouteQuery() {
    return runMScript(
      ...
      { path: "services[2].businessLogic[1].whereClause.fullWhereClause" },
    );
  ...
  async executeMainOperation() {
    return await dbScriptGetMymacrotarget(this);
...
module.exports = GetMyMacroTargetManager;
