...
// This script is called from the DeleteDishManager
...
const dbScriptDeleteDish = async (apiManager) => {
  ...
  try {
    const updateResult = await Dish.update(
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteDish",
      {
...
module.exports = dbScriptDeleteDish;
