...
// This script is called from the CreateDishManager
...
async function updateIfExists(dataClause) {
  const dbDoc = await Dish.findByPk(dataClause.id);
  if (dbDoc) {
...
const dbScriptCreateDish = async (apiManager) => {
  ...
  try {
    ...
    if (!updated) {
      const dbDoc = await Dish.create(dataClause);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptCreateDish",
      {
        whereClause: null,
...
module.exports = dbScriptCreateDish;
