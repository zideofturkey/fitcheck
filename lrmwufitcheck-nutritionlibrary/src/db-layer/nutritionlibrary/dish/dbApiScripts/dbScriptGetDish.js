...
// This script is called from the GetDishManager
...
const dbScriptGetDish = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Dish.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetDish",
      {
...
module.exports = dbScriptGetDish;
