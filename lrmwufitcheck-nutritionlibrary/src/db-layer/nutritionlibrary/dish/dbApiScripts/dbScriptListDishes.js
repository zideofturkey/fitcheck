...
// This script is called from the ListDishsManager
...
const dbScriptListDishes = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListDishes",
      {
...
module.exports = dbScriptListDishes;
