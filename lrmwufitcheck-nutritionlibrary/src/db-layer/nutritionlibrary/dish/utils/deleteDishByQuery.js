...
/**
 * @deprecated Use deleteDishByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const deleteDishByQuery = async (query, context = null) => {
  try {
    ...
    [rowsCount, rows] = await Dish.update(
    ...
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenDeletingDishByQuery", err);
  }
};

module.exports = deleteDishByQuery;
