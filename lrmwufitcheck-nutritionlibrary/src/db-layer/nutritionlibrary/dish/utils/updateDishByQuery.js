...
/**
 * @deprecated Use updateDishByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateDishByQuery = async (dataClause, query, context = null) => {
  try {
    ...
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenUpdatingDishByQuery", err);
  }
};

module.exports = updateDishByQuery;
