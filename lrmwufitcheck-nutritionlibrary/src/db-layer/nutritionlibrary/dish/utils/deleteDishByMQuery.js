...
/**
 * Deletes all Dish records matching an MScript Query.
 ...
 */
const deleteDishByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingDishByMQuery",
      err,
    );
  }
};

module.exports = deleteDishByMQuery;
