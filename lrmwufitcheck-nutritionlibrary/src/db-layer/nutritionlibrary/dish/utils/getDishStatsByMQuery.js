...
/**
 * Calculates statistics on Dish records matching an MScript Query.
 ...
 */
const getDishStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingDishStatsByMQuery",
      err,
    );
  }
};

module.exports = getDishStatsByMQuery;
