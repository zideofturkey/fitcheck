...
/**
 * Updates all Dish records matching an MScript Query.
 ...
 */
const updateDishByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingDishByMQuery",
      err,
    );
  }
};

module.exports = updateDishByMQuery;
