...
/**
 * Calculates statistics on DishLine records matching an MScript Query.
 ...
 */
const getDishLineStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingDishLineStatsByMQuery",
      err,
    );
  }
};

module.exports = getDishLineStatsByMQuery;
