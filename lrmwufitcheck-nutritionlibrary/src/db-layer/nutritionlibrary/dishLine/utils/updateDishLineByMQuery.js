...
/**
 * Updates all DishLine records matching an MScript Query.
 ...
 */
const updateDishLineByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingDishLineByMQuery",
      err,
    );
  }
};

module.exports = updateDishLineByMQuery;
