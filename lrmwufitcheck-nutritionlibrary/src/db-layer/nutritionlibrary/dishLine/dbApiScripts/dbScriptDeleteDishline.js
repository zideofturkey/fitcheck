...
// This script is called from the DeleteDishLineManager
...
const dbScriptDeleteDishline = async (apiManager) => {
  ...
  try {
    const updateResult = await DishLine.update(
    ...
    if (!dbData && rowsCount > 0) {
      dbDoc = await DishLine.findOne({ where: instanceWhereClause });
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteDishline",
      {
...
module.exports = dbScriptDeleteDishline;
