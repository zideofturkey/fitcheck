...
// This script is called from the ListDishLinesManager
...
const dbScriptListDishlines = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListDishlines",
      {
...
module.exports = dbScriptListDishlines;
