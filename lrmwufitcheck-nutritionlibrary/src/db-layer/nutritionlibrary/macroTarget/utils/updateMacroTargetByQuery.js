...
/**
 * @deprecated Use updateMacroTargetByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateMacroTargetByQuery = async (dataClause, query, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingMacroTargetByQuery",
      err,
    );
  }
};

module.exports = updateMacroTargetByQuery;
