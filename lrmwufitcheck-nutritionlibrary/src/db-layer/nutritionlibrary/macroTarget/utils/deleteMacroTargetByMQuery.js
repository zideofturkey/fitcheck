...
/**
 * Deletes all MacroTarget records matching an MScript Query.
 ...
 */
const deleteMacroTargetByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingMacroTargetByMQuery",
      err,
    );
  }
};

module.exports = deleteMacroTargetByMQuery;
