...
/**
 * Calculates statistics on MacroTarget records matching an MScript Query.
 ...
 */
const getMacroTargetStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingMacroTargetStatsByMQuery",
      err,
    );
  }
};

module.exports = getMacroTargetStatsByMQuery;
