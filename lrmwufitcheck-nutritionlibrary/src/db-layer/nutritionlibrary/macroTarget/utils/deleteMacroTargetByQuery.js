...
/**
 * @deprecated Use deleteMacroTargetByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const deleteMacroTargetByQuery = async (query, context = null) => {
  try {
    ...
    [rowsCount, rows] = await MacroTarget.update(
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingMacroTargetByQuery",
      err,
    );
  }
};

module.exports = deleteMacroTargetByQuery;
