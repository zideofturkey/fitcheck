...
// This script is called from the GetMyMacroTargetManager
...
const dbScriptGetMymacrotarget = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetMymacrotarget",
      {
...
module.exports = dbScriptGetMymacrotarget;
