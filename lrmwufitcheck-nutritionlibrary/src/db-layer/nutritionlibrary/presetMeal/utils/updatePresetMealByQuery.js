...
/**
 * @deprecated Use updatePresetMealByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updatePresetMealByQuery = async (dataClause, query, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingPresetMealByQuery",
      err,
    );
  }
};

module.exports = updatePresetMealByQuery;
