...
/**
 * @deprecated Use deletePresetMealByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const deletePresetMealByQuery = async (query, context = null) => {
  try {
    ...
    [rowsCount, rows] = await PresetMeal.update(
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingPresetMealByQuery",
      err,
    );
  }
};

module.exports = deletePresetMealByQuery;
