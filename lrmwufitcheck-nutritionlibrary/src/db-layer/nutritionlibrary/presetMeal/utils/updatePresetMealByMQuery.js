...
/**
 * Updates all PresetMeal records matching an MScript Query.
 ...
 */
const updatePresetMealByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingPresetMealByMQuery",
      err,
    );
  }
};

module.exports = updatePresetMealByMQuery;
