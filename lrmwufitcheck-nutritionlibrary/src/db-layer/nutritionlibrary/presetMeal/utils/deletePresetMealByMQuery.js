...
/**
 * Deletes all PresetMeal records matching an MScript Query.
 ...
 */
const deletePresetMealByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingPresetMealByMQuery",
      err,
    );
  }
};

module.exports = deletePresetMealByMQuery;
