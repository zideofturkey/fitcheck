...
const getPresetMealListByMQuery = async (mQuery) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingPresetMealListByMQuery",
      err,
    );
  }
};

module.exports = getPresetMealListByMQuery;
