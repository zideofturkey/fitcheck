...
/**
 * Calculates statistics on PresetMeal records matching an MScript Query.
 ...
 */
const getPresetMealStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingPresetMealStatsByMQuery",
      err,
    );
  }
};

module.exports = getPresetMealStatsByMQuery;
