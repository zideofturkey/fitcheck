...
// This script is called from the ListPresetMealsManager
...
const dbScriptListPresetmeals = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListPresetmeals",
      {
...
module.exports = dbScriptListPresetmeals;
