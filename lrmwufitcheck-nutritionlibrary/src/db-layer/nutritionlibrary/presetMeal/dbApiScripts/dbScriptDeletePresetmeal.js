...
// This script is called from the DeletePresetMealManager
...
const dbScriptDeletePresetmeal = async (apiManager) => {
  ...
  try {
    const updateResult = await PresetMeal.update(
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeletePresetmeal",
      {
...
module.exports = dbScriptDeletePresetmeal;
