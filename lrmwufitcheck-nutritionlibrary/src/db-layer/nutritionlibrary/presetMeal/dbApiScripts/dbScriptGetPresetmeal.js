...
// This script is called from the GetPresetMealManager
...
const dbScriptGetPresetmeal = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetPresetmeal",
      {
...
module.exports = dbScriptGetPresetmeal;
