...
// This script is called from the DeleteFoodItemManager
...
const dbScriptDeleteFooditem = async (apiManager) => {
  ...
  try {
    const updateResult = await FoodItem.update(
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteFooditem",
      {
...
module.exports = dbScriptDeleteFooditem;
