...
// This script is called from the ListFoodItemsManager
...
const dbScriptListFooditems = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListFooditems",
      {
...
module.exports = dbScriptListFooditems;
