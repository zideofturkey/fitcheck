...
// This script is called from the GetFoodItemForLoggingManager
...
const dbScriptGetFooditemforlogging = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await FoodItem.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetFooditemforlogging",
      {
...
module.exports = dbScriptGetFooditemforlogging;
