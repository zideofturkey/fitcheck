...
// This script is called from the GetFoodItemManager
...
const dbScriptGetFooditem = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetFooditem",
      {
...
module.exports = dbScriptGetFooditem;
