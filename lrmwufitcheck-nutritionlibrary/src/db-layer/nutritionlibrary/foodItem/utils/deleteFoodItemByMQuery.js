...
/**
 * Deletes all FoodItem records matching an MScript Query.
 ...
 */
const deleteFoodItemByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingFoodItemByMQuery",
      err,
    );
  }
};

module.exports = deleteFoodItemByMQuery;
