...
/**
 * Updates all FoodItem records matching an MScript Query.
 ...
 */
const updateFoodItemByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingFoodItemByMQuery",
      err,
    );
  }
};

module.exports = updateFoodItemByMQuery;
