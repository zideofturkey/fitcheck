...
/**
 * @deprecated Use updateFoodItemByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updateFoodItemByQuery = async (dataClause, query, context = null) => {
  try {
    ...
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenUpdatingFoodItemByQuery", err);
  }
};

module.exports = updateFoodItemByQuery;
