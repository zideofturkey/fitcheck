...
/**
 * @deprecated Use deleteFoodItemByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const deleteFoodItemByQuery = async (query, context = null) => {
  try {
    ...
    [rowsCount, rows] = await FoodItem.update(
    ...
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenDeletingFoodItemByQuery", err);
  }
};

module.exports = deleteFoodItemByQuery;
