...
// This script is called from the ListPresetLinesManager
...
const dbScriptListPresetlines = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListPresetlines",
      {
...
module.exports = dbScriptListPresetlines;
