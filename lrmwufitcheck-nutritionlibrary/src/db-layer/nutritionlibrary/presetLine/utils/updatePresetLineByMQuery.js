...
/**
 * Updates all PresetLine records matching an MScript Query.
 ...
 */
const updatePresetLineByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingPresetLineByMQuery",
      err,
    );
  }
};

module.exports = updatePresetLineByMQuery;
