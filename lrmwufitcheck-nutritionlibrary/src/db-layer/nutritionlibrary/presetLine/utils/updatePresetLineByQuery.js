...
/**
 * @deprecated Use updatePresetLineByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const updatePresetLineByQuery = async (dataClause, query, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingPresetLineByQuery",
      err,
    );
  }
};

module.exports = updatePresetLineByQuery;
