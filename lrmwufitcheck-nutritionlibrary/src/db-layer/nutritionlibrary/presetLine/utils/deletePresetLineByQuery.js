...
/**
 * @deprecated Use deletePresetLineByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const deletePresetLineByQuery = async (query, context = null) => {
  try {
    ...
    [rowsCount, rows] = await PresetLine.update(
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingPresetLineByQuery",
      err,
    );
  }
};

module.exports = deletePresetLineByQuery;
