...
/**
 * Deletes all PresetLine records matching an MScript Query.
 ...
 */
const deletePresetLineByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingPresetLineByMQuery",
      err,
    );
  }
};

module.exports = deletePresetLineByMQuery;
