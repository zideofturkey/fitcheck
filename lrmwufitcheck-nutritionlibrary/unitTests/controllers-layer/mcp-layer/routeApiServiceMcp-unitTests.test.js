...
describe("SetMacroTargetMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/macroTarget/set-macrotarget-api.js",
      {
        apiLayer: { SetMacroTargetManager: ManagerStub },
        "../../NutritionLibraryServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("setMacroTarget");
