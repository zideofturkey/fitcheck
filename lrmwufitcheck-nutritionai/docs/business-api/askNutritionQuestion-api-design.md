...
### [10] Action : callGeminiAskNutrition
...
### [11] Action : parseGuidanceGeminiResult

**Action Type**: `FunctionCallAction`

Parses the raw Gemini text response into the structured guidance result object expected by the downstream actions.
...
### [12] Action : updateSessionWithGuidanceResult
