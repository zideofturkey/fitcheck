...
describe("ParseMealMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/aiSession/parse-meal-api.js",
      {
        apiLayer: { ParseMealManager: ManagerStub },
        "../../NutritionAiServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("parseMeal");
