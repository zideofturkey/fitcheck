...
const {
  // nutritionai Database Crud Object Rest Api Routers
  aiSessionRouter,
  aiCandidateMealRouter,
  aiCandidateLineRouter,
  aiGuidanceNoteRouter,
} = require("restLayer");

app.use("", aiSessionRouter);
app.use("", aiCandidateMealRouter);
app.use("", aiCandidateLineRouter);
app.use("", aiGuidanceNoteRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "fitcheck-nutritionAi-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="fitcheck-nutritionAi-postman-collection.json"',
  );
