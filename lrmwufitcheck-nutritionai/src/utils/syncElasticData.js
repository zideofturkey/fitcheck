...
const {
  getAiSessionById,
  getIdListOfAiSessionByField,
  countAiSession,
  getAiCandidateMealById,
  getIdListOfAiCandidateMealByField,
  countAiCandidateMeal,
  getAiCandidateLineById,
  getIdListOfAiCandidateLineByField,
  countAiCandidateLine,
  getAiGuidanceNoteById,
...
const dataObjectRegistry = {
  aiSession: {
    name: "aiSession",
    modelName: "AiSession",
    pluralName: "aiSessions",
    getById: getAiSessionById,
    getIdList: getIdListOfAiSessionByField,
    count: countAiSession,
  },
  aiCandidateMeal: {
    name: "aiCandidateMeal",
    modelName: "AiCandidateMeal",
    pluralName: "aiCandidateMeals",
    getById: getAiCandidateMealById,
    getIdList: getIdListOfAiCandidateMealByField,
    count: countAiCandidateMeal,
  },
  aiCandidateLine: {
    name: "aiCandidateLine",
    modelName: "AiCandidateLine",
    pluralName: "aiCandidateLines",
    getById: getAiCandidateLineById,
    getIdList: getIdListOfAiCandidateLineByField,
    count: countAiCandidateLine,
  },
  aiGuidanceNote: {
    name: "aiGuidanceNote",
    modelName: "AiGuidanceNote",
    pluralName: "aiGuidanceNotes",
    getById: getAiGuidanceNoteById,
    getIdList: getIdListOfAiGuidanceNoteByField,
    count: countAiGuidanceNote,
  },
};
