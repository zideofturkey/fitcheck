...
console.log("Starting fitcheck-nutritionai-service service...");
...
const start = async () => {
  process.title = "node-lrmwufitcheck-nutritionai-service";
  ...
  try {
    ...
    await setRedisData(
      "lrmwufitcheck-nutritionai-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key lrmwufitcheck-nutritionai-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "fitcheck-nutritionai-service is listening HTTP/REST port " +
...
/* starting the server fitcheck-nutritionai-service .... */
start();
