...
const { dbScript_fetchListaisession } = require("dbLayer");
...
class _fetchListAiSessionManager extends AiSessionManager {
  ...
  async executeMainOperation() {
    return await dbScript_fetchListaisession(this);
...
module.exports = _fetchListAiSessionManager;
