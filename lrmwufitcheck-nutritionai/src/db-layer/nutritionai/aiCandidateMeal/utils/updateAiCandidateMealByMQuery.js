...
/**
 * Updates all AiCandidateMeal records matching an MScript Query.
 ...
 */
const updateAiCandidateMealByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingAiCandidateMealByMQuery",
      err,
    );
  }
};

module.exports = updateAiCandidateMealByMQuery;
