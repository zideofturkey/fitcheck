...
/**
 * Deletes all AiCandidateMeal records matching an MScript Query.
 ...
 */
const deleteAiCandidateMealByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingAiCandidateMealByMQuery",
      err,
    );
  }
};

module.exports = deleteAiCandidateMealByMQuery;
