...
// This script is called from the ListAiCandidateMealsManager
...
const dbScriptListAicandidatemeals = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListAicandidatemeals",
      {
...
module.exports = dbScriptListAicandidatemeals;
