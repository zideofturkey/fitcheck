...
// This script is called from the GetAiCandidateMealManager
...
const dbScriptGetAicandidatemeal = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await AiCandidateMeal.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetAicandidatemeal",
      {
...
module.exports = dbScriptGetAicandidatemeal;
