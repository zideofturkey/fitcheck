...
// This script is called from the GetAiSessionManager
...
const dbScriptGetAisession = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await AiSession.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetAisession",
      {
...
module.exports = dbScriptGetAisession;
