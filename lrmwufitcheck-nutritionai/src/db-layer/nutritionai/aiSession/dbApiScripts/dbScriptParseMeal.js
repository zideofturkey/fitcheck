...
// This script is called from the ParseMealManager
...
const dbScriptParseMeal = async (apiManager) => {
  ...
  try {
    ...
    console.log(err);
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenExecuting_dbScriptParseMeal", {
      whereClause: null,
...
module.exports = dbScriptParseMeal;
