...
// This script is called from the ListAiSessionsManager
...
const dbScriptListAisessions = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListAisessions",
      {
...
module.exports = dbScriptListAisessions;
