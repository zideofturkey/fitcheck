...
/**
 * @deprecated Use deleteAiSessionByMQuery instead, which accepts database-agnostic MScript Query format.
 */
const deleteAiSessionByQuery = async (query, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingAiSessionByQuery",
      err,
    );
  }
};

module.exports = deleteAiSessionByQuery;
