...
/**
 * Calculates statistics on AiSession records matching an MScript Query.
 ...
 */
const getAiSessionStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingAiSessionStatsByMQuery",
      err,
    );
  }
};

module.exports = getAiSessionStatsByMQuery;
