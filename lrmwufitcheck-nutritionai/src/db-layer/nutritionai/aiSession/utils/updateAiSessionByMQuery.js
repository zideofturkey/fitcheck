...
/**
 * Updates all AiSession records matching an MScript Query.
 ...
 */
const updateAiSessionByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingAiSessionByMQuery",
      err,
    );
  }
};

module.exports = updateAiSessionByMQuery;
