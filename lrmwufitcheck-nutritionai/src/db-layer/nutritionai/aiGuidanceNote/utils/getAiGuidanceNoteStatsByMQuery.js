...
/**
 * Calculates statistics on AiGuidanceNote records matching an MScript Query.
 ...
 */
const getAiGuidanceNoteStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingAiGuidanceNoteStatsByMQuery",
      err,
    );
  }
};

module.exports = getAiGuidanceNoteStatsByMQuery;
