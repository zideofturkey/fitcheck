...
/**
 * Deletes all AiGuidanceNote records matching an MScript Query.
 ...
 */
const deleteAiGuidanceNoteByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingAiGuidanceNoteByMQuery",
      err,
    );
  }
};

module.exports = deleteAiGuidanceNoteByMQuery;
