...
/**
 * Updates all AiGuidanceNote records matching an MScript Query.
 ...
 */
const updateAiGuidanceNoteByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingAiGuidanceNoteByMQuery",
      err,
    );
  }
};

module.exports = updateAiGuidanceNoteByMQuery;
