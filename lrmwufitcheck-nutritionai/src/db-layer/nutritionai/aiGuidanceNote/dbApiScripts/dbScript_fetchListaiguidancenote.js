...
// This script is called from the _fetchListAiGuidanceNoteManager
...
const dbScript_fetchListaiguidancenote = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScript_fetchListaiguidancenote",
      {
...
module.exports = dbScript_fetchListaiguidancenote;
