...
/**
 * Deletes all AiCandidateLine records matching an MScript Query.
 ...
 */
const deleteAiCandidateLineByMQuery = async (mQuery, context = null) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenDeletingAiCandidateLineByMQuery",
      err,
    );
  }
};

module.exports = deleteAiCandidateLineByMQuery;
