...
/**
 * Calculates statistics on AiCandidateLine records matching an MScript Query.
 ...
 */
const getAiCandidateLineStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingAiCandidateLineStatsByMQuery",
      err,
    );
  }
};

module.exports = getAiCandidateLineStatsByMQuery;
