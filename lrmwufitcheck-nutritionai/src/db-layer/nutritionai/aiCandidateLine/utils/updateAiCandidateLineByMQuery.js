...
/**
 * Updates all AiCandidateLine records matching an MScript Query.
 ...
 */
const updateAiCandidateLineByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingAiCandidateLineByMQuery",
      err,
    );
  }
};

module.exports = updateAiCandidateLineByMQuery;
