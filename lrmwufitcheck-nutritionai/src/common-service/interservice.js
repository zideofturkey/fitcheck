...
const InterService = {
  ...
  /**
   * Call agentHub service - listAgentChats API
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubListAgentChats(params = {}, options = {}) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
    if (!serviceUrl) {
      throw new Error(
        `Service URL not found for agentHub. Please set AGENTHUB_SERVICE_URL environment variable.`,
    ...
    // Build full URL with route path
    let fullUrl = serviceUrl.replace(/\/$/, "") + "/v1/agentchats";
  ...
  /**
   * Call agentHub service - getAgentChatMessages API
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubGetAgentChatMessages(params = {}, options = {}) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
    if (!serviceUrl) {
      throw new Error(
        `Service URL not found for agentHub. Please set AGENTHUB_SERVICE_URL environment variable.`,
  ...
  /**
   * Call agentHub service - _fetchListSys_agentConversation API
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubFetchListSysagentConversation(params = {}, options = {}) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
    if (!serviceUrl) {
      throw new Error(
        `Service URL not found for agentHub. Please set AGENTHUB_SERVICE_URL environment variable.`,
    ...
    // Build full URL with route path
    let fullUrl =
      serviceUrl.replace(/\/$/, "") + "/v1/_fetchlistsys_agentconversation";
  ...
  /**
   * Call agentHub service - m2mCreateSys_agentConversation edge controller
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubM2mCreateSysagentConversation(params = {}, options = {}) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
    if (!serviceUrl) {
      throw new Error(
        `Service URL not found for agentHub. Please set AGENTHUB_SERVICE_URL environment variable.`,
    ...
    // Build full URL with route path
    let fullUrl =
      serviceUrl.replace(/\/$/, "") + "/m2m/sys_agentconversation/create";
  ...
  /**
   * Call agentHub service - m2mBulkCreateSys_agentConversation edge controller
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubM2mBulkCreateSysagentConversation(
    params = {},
    options = {},
  ) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
    ...
    // Build full URL with route path
    let fullUrl =
      serviceUrl.replace(/\/$/, "") + "/m2m/sys_agentconversation/bulk-create";
  ...
  /**
   * Call agentHub service - m2mUpdateSys_agentConversationById edge controller
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubM2mUpdateSysagentConversationById(
    params = {},
    options = {},
  ) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
    ...
    // Build full URL with route path
    let fullUrl =
      serviceUrl.replace(/\/$/, "") + "/m2m/sys_agentconversation/update/:id";
  ...
  /**
   * Call agentHub service - m2mDeleteSys_agentConversationById edge controller
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubM2mDeleteSysagentConversationById(
    params = {},
    options = {},
  ) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
    ...
    // Build full URL with route path
    let fullUrl =
      serviceUrl.replace(/\/$/, "") + "/m2m/sys_agentconversation/delete/:id";
  ...
  /**
   * Call agentHub service - m2mUpdateSys_agentConversationByQuery edge controller
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubM2mUpdateSysagentConversationByQuery(
    params = {},
    options = {},
  ) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
  ...
  /**
   * Call agentHub service - m2mDeleteSys_agentConversationByQuery edge controller
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubM2mDeleteSysagentConversationByQuery(
    params = {},
    options = {},
  ) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
  ...
  /**
   * Call agentHub service - m2mUpdateSys_agentConversationByIdList edge controller
   * @param {Object} params - Request parameters (body, query, path params)
   * @param {Object} options - Additional options (headers, cookies, serializer)
   * @returns {Promise<Object>} Response data
   */
  async callAgentHubM2mUpdateSysagentConversationByIdList(
    params = {},
    options = {},
  ) {
    const serviceUrl = process.env.AGENTHUB_SERVICE_URL;
