...
const schemas = {
  aiSession: require("./aiSession.schema"),
  aiCandidateMeal: require("./aiCandidateMeal.schema"),
  aiCandidateLine: require("./aiCandidateLine.schema"),
  aiGuidanceNote: require("./aiGuidanceNote.schema"),
};
