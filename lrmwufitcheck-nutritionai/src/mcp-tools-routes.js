...
function collectAllTools(headers) {
  ...
  const {
    aiSessionMcpRouter,
    aiCandidateMealMcpRouter,
    aiCandidateLineMcpRouter,
    aiGuidanceNoteMcpRouter,
    getSessionRouter,
  } = mcpExports;
  ...
  (aiSessionMcpRouter || []).forEach(addTool);
  (aiCandidateMealMcpRouter || []).forEach(addTool);
  (aiCandidateLineMcpRouter || []).forEach(addTool);
  (aiGuidanceNoteMcpRouter || []).forEach(addTool);
