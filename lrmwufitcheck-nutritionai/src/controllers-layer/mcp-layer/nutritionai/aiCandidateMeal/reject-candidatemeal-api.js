...
class RejectCandidateMealMcpController extends NutritionAiServiceMcpController {
  constructor(params) {
    super("rejectCandidateMeal", "rejectcandidatemeal", params);
    this.dataName = "aiCandidateMeal";
    this.crudType = "update";
  }

  createApiManager() {
    return new RejectCandidateMealManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    description:
      ...
      requiredRolesMarker,
    requiredRoles,
    parameters: RejectCandidateMealMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new RejectCandidateMealMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return RejectCandidateMealMcpController.getOutputSchema().parse(result);
