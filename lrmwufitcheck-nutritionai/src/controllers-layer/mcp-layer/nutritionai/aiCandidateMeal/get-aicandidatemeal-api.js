...
class GetAiCandidateMealMcpController extends NutritionAiServiceMcpController {
  constructor(params) {
    super("getAiCandidateMeal", "getaicandidatemeal", params);
    this.dataName = "aiCandidateMeal";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetAiCandidateMealManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    description:
      ...
      requiredRolesMarker,
    requiredRoles,
    parameters: GetAiCandidateMealMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetAiCandidateMealMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetAiCandidateMealMcpController.getOutputSchema().parse(result);
