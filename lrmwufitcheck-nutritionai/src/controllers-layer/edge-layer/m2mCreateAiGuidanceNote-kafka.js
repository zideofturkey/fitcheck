...
const m2mCreateAiGuidanceNoteHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateAiGuidanceNoteRequiresM2MToken",
    ...
    const result = await m2mCreateAiGuidanceNote(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mCreateAiGuidanceNoteHandler;
