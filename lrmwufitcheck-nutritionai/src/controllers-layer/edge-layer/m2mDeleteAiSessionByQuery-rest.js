...
const m2mDeleteAiSessionByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteAiSessionByQueryInvalidM2MToken",
    ...
    const result = await m2mDeleteAiSessionByQuery(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteAiSessionByQuery: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteAiSessionByQueryRestController;
