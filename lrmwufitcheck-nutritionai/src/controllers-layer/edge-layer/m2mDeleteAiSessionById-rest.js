...
const m2mDeleteAiSessionByIdRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteAiSessionByIdInvalidM2MToken",
    ...
    const result = await m2mDeleteAiSessionById(req);
    ...
    console.error(
      "Error running routeService for m2mDeleteAiSessionById: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mDeleteAiSessionByIdRestController;
