...
const m2mDeleteAiGuidanceNoteByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteAiGuidanceNoteByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteAiGuidanceNoteByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteAiGuidanceNoteByQueryHandler;
