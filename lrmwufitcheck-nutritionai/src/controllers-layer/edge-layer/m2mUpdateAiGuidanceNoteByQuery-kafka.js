...
const m2mUpdateAiGuidanceNoteByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiGuidanceNoteByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateAiGuidanceNoteByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiGuidanceNoteByQueryHandler;
