...
const m2mDeleteAiSessionByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteAiSessionByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteAiSessionById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteAiSessionByIdHandler;
