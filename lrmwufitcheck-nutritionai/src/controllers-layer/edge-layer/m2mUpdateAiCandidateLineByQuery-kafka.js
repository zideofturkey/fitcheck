...
const m2mUpdateAiCandidateLineByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiCandidateLineByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateAiCandidateLineByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiCandidateLineByQueryHandler;
