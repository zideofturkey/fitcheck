...
const m2mDeleteAiCandidateLineByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteAiCandidateLineByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteAiCandidateLineById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteAiCandidateLineByIdHandler;
