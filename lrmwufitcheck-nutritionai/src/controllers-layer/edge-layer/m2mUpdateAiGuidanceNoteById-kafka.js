...
const m2mUpdateAiGuidanceNoteByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiGuidanceNoteByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateAiGuidanceNoteById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiGuidanceNoteByIdHandler;
