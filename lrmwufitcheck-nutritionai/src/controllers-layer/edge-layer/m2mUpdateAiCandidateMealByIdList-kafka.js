...
const m2mUpdateAiCandidateMealByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiCandidateMealByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateAiCandidateMealByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiCandidateMealByIdListHandler;
