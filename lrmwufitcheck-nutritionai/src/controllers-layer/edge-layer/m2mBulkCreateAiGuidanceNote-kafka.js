...
const m2mBulkCreateAiGuidanceNoteHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateAiGuidanceNoteRequiresM2MToken",
    ...
    const result = await m2mBulkCreateAiGuidanceNote(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateAiGuidanceNoteHandler;
