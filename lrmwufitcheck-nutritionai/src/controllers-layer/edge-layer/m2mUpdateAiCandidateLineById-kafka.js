...
const m2mUpdateAiCandidateLineByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiCandidateLineByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateAiCandidateLineById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiCandidateLineByIdHandler;
