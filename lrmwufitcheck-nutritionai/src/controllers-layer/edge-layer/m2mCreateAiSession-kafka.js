...
const m2mCreateAiSessionHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateAiSessionRequiresM2MToken",
    ...
    const result = await m2mCreateAiSession(message);
    // log result
  } catch (err) {
...
module.exports = m2mCreateAiSessionHandler;
