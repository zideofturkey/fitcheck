...
const m2mBulkCreateAiSessionHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateAiSessionRequiresM2MToken",
    ...
    const result = await m2mBulkCreateAiSession(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateAiSessionHandler;
