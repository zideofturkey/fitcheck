...
const m2mBulkCreateAiCandidateLineHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateAiCandidateLineRequiresM2MToken",
    ...
    const result = await m2mBulkCreateAiCandidateLine(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateAiCandidateLineHandler;
