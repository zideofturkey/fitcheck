...
const m2mUpdateAiSessionByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiSessionByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateAiSessionById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiSessionByIdHandler;
