...
const { m2mDeleteAiCandidateLineByQuery } = require("edgeFunctions");

const m2mDeleteAiCandidateLineByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteAiCandidateLineByQueryInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteAiCandidateLineByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteAiCandidateLineByQuery(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mDeleteAiCandidateLineByQuery: ",
      err,
    );
    // log error
  }
...
module.exports = m2mDeleteAiCandidateLineByQueryHandler;
