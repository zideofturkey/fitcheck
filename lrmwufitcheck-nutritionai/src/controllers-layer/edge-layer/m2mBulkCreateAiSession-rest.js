...
const m2mBulkCreateAiSessionRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mBulkCreateAiSessionInvalidM2MToken",
    ...
    const result = await m2mBulkCreateAiSession(req);
    ...
    console.error(
      "Error running routeService for m2mBulkCreateAiSession: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mBulkCreateAiSessionRestController;
