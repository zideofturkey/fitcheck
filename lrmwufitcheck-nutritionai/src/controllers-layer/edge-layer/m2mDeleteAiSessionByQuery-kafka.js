...
const m2mDeleteAiSessionByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteAiSessionByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteAiSessionByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteAiSessionByQueryHandler;
