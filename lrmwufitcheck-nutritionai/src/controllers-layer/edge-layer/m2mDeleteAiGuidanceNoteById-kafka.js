...
const m2mDeleteAiGuidanceNoteByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteAiGuidanceNoteByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteAiGuidanceNoteById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteAiGuidanceNoteByIdHandler;
