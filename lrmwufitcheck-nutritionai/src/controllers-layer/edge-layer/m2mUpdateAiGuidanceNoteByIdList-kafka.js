...
const { m2mUpdateAiGuidanceNoteByIdList } = require("edgeFunctions");

const m2mUpdateAiGuidanceNoteByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateAiGuidanceNoteByIdListInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiGuidanceNoteByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateAiGuidanceNoteByIdList(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mUpdateAiGuidanceNoteByIdList: ",
      err,
    );
    // log error
  }
...
module.exports = m2mUpdateAiGuidanceNoteByIdListHandler;
