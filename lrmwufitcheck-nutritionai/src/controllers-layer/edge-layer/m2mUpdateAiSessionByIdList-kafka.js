...
const m2mUpdateAiSessionByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiSessionByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateAiSessionByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiSessionByIdListHandler;
