...
const m2mUpdateAiSessionByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateAiSessionByQueryInvalidM2MToken",
    ...
    const result = await m2mUpdateAiSessionByQuery(req);
    ...
    console.error(
      "Error running routeService for m2mUpdateAiSessionByQuery: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mUpdateAiSessionByQueryRestController;
