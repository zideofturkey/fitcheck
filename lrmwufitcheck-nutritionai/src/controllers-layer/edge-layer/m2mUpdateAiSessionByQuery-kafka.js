...
const m2mUpdateAiSessionByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiSessionByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateAiSessionByQuery(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiSessionByQueryHandler;
