...
const { m2mUpdateAiCandidateLineByIdList } = require("edgeFunctions");

const m2mUpdateAiCandidateLineByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateAiCandidateLineByIdListInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiCandidateLineByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateAiCandidateLineByIdList(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mUpdateAiCandidateLineByIdList: ",
      err,
    );
    // log error
  }
...
module.exports = m2mUpdateAiCandidateLineByIdListHandler;
