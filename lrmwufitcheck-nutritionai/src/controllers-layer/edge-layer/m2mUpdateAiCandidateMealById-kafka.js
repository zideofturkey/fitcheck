...
const m2mUpdateAiCandidateMealByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateAiCandidateMealByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateAiCandidateMealById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateAiCandidateMealByIdHandler;
