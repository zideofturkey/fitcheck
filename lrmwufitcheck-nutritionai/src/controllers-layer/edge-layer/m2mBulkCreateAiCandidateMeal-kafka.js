...
const m2mBulkCreateAiCandidateMealHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateAiCandidateMealRequiresM2MToken",
    ...
    const result = await m2mBulkCreateAiCandidateMeal(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateAiCandidateMealHandler;
