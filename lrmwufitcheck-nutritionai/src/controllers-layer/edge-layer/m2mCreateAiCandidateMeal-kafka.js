...
const m2mCreateAiCandidateMealHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateAiCandidateMealRequiresM2MToken",
    ...
    const result = await m2mCreateAiCandidateMeal(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mCreateAiCandidateMealHandler;
