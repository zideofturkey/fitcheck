...
/**
 * Updates all User records matching an MScript Query.
 ...
 */
const updateUserByMQuery = async (dataClause, mQuery, context = null) => {
  try {
    ...
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenUpdatingUserByMQuery", err);
  }
};

module.exports = updateUserByMQuery;
