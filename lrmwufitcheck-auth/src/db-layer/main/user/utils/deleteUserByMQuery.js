...
/**
 * Deletes all User records matching an MScript Query.
 ...
 */
const deleteUserByMQuery = async (mQuery, context = null) => {
  try {
    ...
    [rowsCount, rows] = await User.update(
    ...
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenDeletingUserByMQuery", err);
  }
};

module.exports = deleteUserByMQuery;
