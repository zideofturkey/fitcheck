...
// This script is called from the SearchUsersManager
...
const dbScriptSearchUsers = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptSearchUsers",
      {
...
module.exports = dbScriptSearchUsers;
