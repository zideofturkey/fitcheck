...
// This script is called from the ArchiveProfileManager
...
const dbScriptArchiveProfile = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptArchiveProfile",
      {
...
module.exports = dbScriptArchiveProfile;
