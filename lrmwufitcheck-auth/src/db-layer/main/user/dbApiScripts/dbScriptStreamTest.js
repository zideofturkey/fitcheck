...
// This script is called from the StreamTestManager
...
const dbScriptStreamTest = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptStreamTest",
      {
...
module.exports = dbScriptStreamTest;
