...
/**
 * Calculates statistics on UserAvatarsFile records matching an MScript Query.
 ...
 */
const getUserAvatarsFileStatsByMQuery = async (mQuery, stats) => {
  const promises = [];
  const statLabels = [];
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenRequestingUserAvatarsFileStatsByMQuery",
      err,
    );
  }
};

module.exports = getUserAvatarsFileStatsByMQuery;
