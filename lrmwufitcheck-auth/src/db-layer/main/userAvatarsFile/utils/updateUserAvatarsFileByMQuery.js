...
/**
 * Updates all UserAvatarsFile records matching an MScript Query.
 ...
 */
const updateUserAvatarsFileByMQuery = async (
  dataClause,
  mQuery,
  context = null,
) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenUpdatingUserAvatarsFileByMQuery",
      err,
    );
  }
};

module.exports = updateUserAvatarsFileByMQuery;
