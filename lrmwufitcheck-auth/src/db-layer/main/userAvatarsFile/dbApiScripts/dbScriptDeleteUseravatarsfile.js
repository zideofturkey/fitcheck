...
// This script is called from the DeleteUserAvatarsFileManager
...
const dbScriptDeleteUseravatarsfile = async (apiManager) => {
  ...
  try {
    const res = await UserAvatarsFile.destroy({ where: instanceWhereClause });
    ...
    apiManager.userAvatarsFile = dbData;
    ...
    const queryCacheInvalidator = new UserAvatarsFileQueryCacheInvalidator();
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteUseravatarsfile",
      {
...
module.exports = dbScriptDeleteUseravatarsfile;
