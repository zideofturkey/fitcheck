...
// This script is called from the GetUserAvatarsFileManager
...
const dbScriptGetUseravatarsfile = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await UserAvatarsFile.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetUseravatarsfile",
      {
...
module.exports = dbScriptGetUseravatarsfile;
