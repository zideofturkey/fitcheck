...
class ListUserAvatarsFilesMcpController extends AuthServiceMcpController {
  constructor(params) {
    super("listUserAvatarsFiles", "listuseravatarsfiles", params);
    this.dataName = "userAvatarsFiles";
    this.crudType = "list";
  }

  createApiManager() {
    return new ListUserAvatarsFilesManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    requiredRoles,
    parameters: ListUserAvatarsFilesMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new ListUserAvatarsFilesMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return ListUserAvatarsFilesMcpController.getOutputSchema().parse(result);
