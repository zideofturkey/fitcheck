...
class DeleteUserAvatarsFileMcpController extends AuthServiceMcpController {
  constructor(params) {
    super("deleteUserAvatarsFile", "deleteuseravatarsfile", params);
    this.dataName = "userAvatarsFile";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteUserAvatarsFileManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    requiredRoles,
    parameters: DeleteUserAvatarsFileMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new DeleteUserAvatarsFileMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return DeleteUserAvatarsFileMcpController.getOutputSchema().parse(result);
