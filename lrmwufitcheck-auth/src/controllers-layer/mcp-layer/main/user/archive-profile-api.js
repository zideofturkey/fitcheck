...
class ArchiveProfileMcpController extends AuthServiceMcpController {
  constructor(params) {
    super("archiveProfile", "archiveprofile", params);
    this.dataName = "user";
    this.crudType = "delete";
  }

  createApiManager() {
    return new ArchiveProfileManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  ...
  return {
    ...
    description:
      ...
      requiredRolesMarker,
    requiredRoles,
    parameters: ArchiveProfileMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new ArchiveProfileMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return ArchiveProfileMcpController.getOutputSchema().parse(result);
