...
const { m2mDeleteUserById } = require("edgeFunctions");

const m2mDeleteUserByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteUserByIdInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteUserByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteUserById(message);
    // log result
  } catch (err) {
    console.error("Error running routeService for m2mDeleteUserById: ", err);
    // log error
  }
};

module.exports = m2mDeleteUserByIdHandler;
