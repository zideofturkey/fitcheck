...
const m2mUpdateUserAvatarsFileByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateUserAvatarsFileByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateUserAvatarsFileById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateUserAvatarsFileByIdHandler;
