...
const m2mUpdateUserByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateUserByIdRequiresM2MToken",
    ...
    const result = await m2mUpdateUserById(message);
    // log result
  } catch (err) {
...
module.exports = m2mUpdateUserByIdHandler;
