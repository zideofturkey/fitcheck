...
const m2mUpdateUserByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateUserByQueryRequiresM2MToken",
    ...
    const result = await m2mUpdateUserByQuery(message);
    // log result
  } catch (err) {
...
module.exports = m2mUpdateUserByQueryHandler;
