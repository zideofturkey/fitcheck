...
const { m2mUpdateUserAvatarsFileByIdList } = require("edgeFunctions");

const m2mUpdateUserAvatarsFileByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateUserAvatarsFileByIdListInvalidM2MToken",
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateUserAvatarsFileByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateUserAvatarsFileByIdList(message);
    // log result
  } catch (err) {
    console.error(
      "Error running routeService for m2mUpdateUserAvatarsFileByIdList: ",
      err,
    );
    // log error
  }
...
module.exports = m2mUpdateUserAvatarsFileByIdListHandler;
