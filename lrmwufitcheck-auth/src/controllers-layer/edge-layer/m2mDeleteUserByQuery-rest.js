...
const m2mDeleteUserByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mDeleteUserByQueryInvalidM2MToken",
    ...
    const result = await m2mDeleteUserByQuery(req);
    ...
    console.error("Error running routeService for m2mDeleteUserByQuery: ", err);
    return next(err);
  }
};

module.exports = m2mDeleteUserByQueryRestController;
