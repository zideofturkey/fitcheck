...
const m2mDeleteUserAvatarsFileByIdHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteUserAvatarsFileByIdRequiresM2MToken",
    ...
    const result = await m2mDeleteUserAvatarsFileById(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mDeleteUserAvatarsFileByIdHandler;
