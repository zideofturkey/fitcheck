...
const m2mUpdateUserByIdListHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mUpdateUserByIdListRequiresM2MToken",
    ...
    const result = await m2mUpdateUserByIdList(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mUpdateUserByIdListHandler;
