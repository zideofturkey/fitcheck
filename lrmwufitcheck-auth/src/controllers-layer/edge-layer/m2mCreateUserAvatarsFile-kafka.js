...
const m2mCreateUserAvatarsFileHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mCreateUserAvatarsFileRequiresM2MToken",
    ...
    const result = await m2mCreateUserAvatarsFile(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mCreateUserAvatarsFileHandler;
