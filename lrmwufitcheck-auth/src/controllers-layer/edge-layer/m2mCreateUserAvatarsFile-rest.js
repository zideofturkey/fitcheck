...
const m2mCreateUserAvatarsFileRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mCreateUserAvatarsFileInvalidM2MToken",
    ...
    const result = await m2mCreateUserAvatarsFile(req);
    ...
    console.error(
      "Error running routeService for m2mCreateUserAvatarsFile: ",
      err,
    );
    return next(err);
  }
...
module.exports = m2mCreateUserAvatarsFileRestController;
