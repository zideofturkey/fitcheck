...
const m2mUpdateUserByQueryRestController = async (req, res, next) => {
  try {
    ...
    if (req.M2MToken) {
      ...
      if (!m2mPayload) {
        throw new NotAuthenticatedError(
          "m2mUpdateUserByQueryInvalidM2MToken",
    ...
    const result = await m2mUpdateUserByQuery(req);
    ...
    console.error("Error running routeService for m2mUpdateUserByQuery: ", err);
    return next(err);
  }
};

module.exports = m2mUpdateUserByQueryRestController;
