...
const m2mDeleteUserByQueryHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mDeleteUserByQueryRequiresM2MToken",
    ...
    const result = await m2mDeleteUserByQuery(message);
    // log result
  } catch (err) {
...
module.exports = m2mDeleteUserByQueryHandler;
