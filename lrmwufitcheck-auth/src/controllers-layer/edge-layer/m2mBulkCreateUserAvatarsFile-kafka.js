...
const m2mBulkCreateUserAvatarsFileHandler = async (
  topic,
  session,
  message,
  callbackData,
  ...
  try {
    ...
    if (m2mToken) {
      ...
      throw new NotAuthenticatedError(
        "m2mBulkCreateUserAvatarsFileRequiresM2MToken",
    ...
    const result = await m2mBulkCreateUserAvatarsFile(message);
    // log result
  } catch (err) {
    console.error(
...
module.exports = m2mBulkCreateUserAvatarsFileHandler;
