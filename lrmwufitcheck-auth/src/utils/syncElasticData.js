...
const {
  ...
  countUser,
  getUserAvatarsFileById,
  getIdListOfUserAvatarsFileByField,
  countUserAvatarsFile,
} = require("dbLayer");
...
const dataObjectRegistry = {
  user: {
    ...
    pluralName: "users",
    getById: getUserById,
    getIdList: getIdListOfUserByField,
    count: countUser,
  },
  userAvatarsFile: {
    name: "userAvatarsFile",
    modelName: "UserAvatarsFile",
    pluralName: "userAvatarsFiles",
    getById: getUserAvatarsFileById,
    getIdList: getIdListOfUserAvatarsFileByField,
    count: countUserAvatarsFile,
  },
};
