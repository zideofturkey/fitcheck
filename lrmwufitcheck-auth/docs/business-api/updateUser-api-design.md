...
```js
{
  fullname: runMScript(() => (this.fullname), {"path":"services[0].businessLogic[1].dataClauseItems[0].value"}),
  avatar: runMScript(() => (this.avatar), {"path":"services[0].businessLogic[1].dataClauseItems[1].value"}),
}
```
